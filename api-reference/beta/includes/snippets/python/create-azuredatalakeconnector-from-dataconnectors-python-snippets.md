...
request_body.displayName = 'CSV connector'
...
request_configuration = DataConnectorsRequestBuilderPostRequestConfiguration(
)


result = await client.external.industryData.dataConnectors.post(request_body = request_body)
