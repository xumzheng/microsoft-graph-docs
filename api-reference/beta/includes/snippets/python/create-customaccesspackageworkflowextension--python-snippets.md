...
result = await client.identityGovernance_entitlementManagement_accessPackageCatalogsby_id('accessPackageCatalog-id')_customAccessPackageWorkflowExtensions.post(request_body)
