...
result = await client.identityGovernance.accessReviews.definitionsById('accessReviewScheduleDefinition-id').instancesById('accessReviewInstance-id').stagesById('accessReviewStage-id').patch(request_body)
