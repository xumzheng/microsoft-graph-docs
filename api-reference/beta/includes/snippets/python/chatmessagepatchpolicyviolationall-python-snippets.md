...
policy_violation_policy_tip = ChatMessagePolicyViolationPolicyTip()
...
policyViolation.policy_tip = policyViolationPolicyTip
...
request_body.policy_violation = policyViolation
