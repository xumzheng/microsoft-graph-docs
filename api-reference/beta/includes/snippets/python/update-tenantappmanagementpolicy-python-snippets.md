...
request_config = DefaultAppManagementPolicyRequestBuilderPatchRequestConfiguration(
request_config = DefaultAppManagementPolicyRequestBuilderPatchRequestConfiguration(query_params=)


result = await client.policies.defaultAppManagementPolicy.patch(request_body, headers=)
