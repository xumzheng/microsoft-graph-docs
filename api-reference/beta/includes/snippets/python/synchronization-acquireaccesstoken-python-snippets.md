...
request_config = AcquireAccessTokenRequestBuilderPostRequestConfiguration(
request_config = AcquireAccessTokenRequestBuilderPostRequestConfiguration(query_params=)


await client.applications_by_id('application-id').synchronization.acquireAccessToken.post(request_body, headers=)
