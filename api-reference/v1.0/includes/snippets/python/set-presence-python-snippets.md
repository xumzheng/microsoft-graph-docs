...
request_config = SetPresenceRequestBuilderPostRequestConfiguration(
request_config = SetPresenceRequestBuilderPostRequestConfiguration(query_params=)


await client.users_by_id('user-id').presence.setPresence.post(request_body, headers=)
