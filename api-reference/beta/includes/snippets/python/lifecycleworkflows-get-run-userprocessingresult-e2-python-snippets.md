...
request_config = UserProcessingResultRequestBuilderGetRequestConfiguration(query_params=query_params = UserProcessingResultRequestBuilderGetQueryParameters()
