...
result = await client.tenantRelationships.delegatedAdminRelationshipsby_id('delegatedAdminRelationship-id').accessAssignmentsby_id('delegatedAdminAccessAssignment-id').patch(request_body, request_config)
