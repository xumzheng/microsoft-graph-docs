...
requestBody = GetRemoteConnectionHistoricalReportsPostRequestBody();
...
await client.deviceManagement().virtualEndpoint().reports().getRemoteConnectionHistoricalReports().post(requestBody);
