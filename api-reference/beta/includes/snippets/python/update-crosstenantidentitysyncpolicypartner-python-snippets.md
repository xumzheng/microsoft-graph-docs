...
result = await client.policies.crossTenantAccessPolicy.partners._by_id('crossTenantAccessPolicyConfigurationPartner-tenantId').identitySynchronization.patch(request_body)
