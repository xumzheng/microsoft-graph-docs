...
request_config = AlertRuleRequestBuilderPatchRequestConfiguration(
request_config = AlertRuleRequestBuilderPatchRequestConfiguration(query_params=)


result = await client.deviceManagement.monitoring.alertRules_by_id('alertRule-id').patch(request_body, headers=)
