...
result = await client.security.cases.ediscoveryCases_by_id('ediscoveryCase-id').legalHolds_by_id('ediscoveryHoldPolicy-id').userSources.post(request_body = request_body)
