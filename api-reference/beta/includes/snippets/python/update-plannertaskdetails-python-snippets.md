...
request_body.setDescription('Updated task details properties:\nUpdated checklist:Sub items\nUpdated references:Related links')


request_configuration = DetailsRequestBuilderPatchRequestConfiguration(
request_configuration = DetailsRequestBuilderPatchRequestConfiguration(query_params=)
System.Collections.Generic.List`1[System.Tuple`2[System.String,System.String]])


result = await client.planner.tasks_by_id('plannerTask-id').details.patch(request_body, request_configuration)
