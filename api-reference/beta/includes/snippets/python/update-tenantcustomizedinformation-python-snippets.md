...
request_config = TenantCustomizedInformationRequestBuilderPatchRequestConfiguration(
request_config = TenantCustomizedInformationRequestBuilderPatchRequestConfiguration(query_params=)


result = await client.tenantRelationships.managedTenants.tenantsCustomizedInformation_by_id('tenantCustomizedInformation-id').patch(request_body, headers=)
