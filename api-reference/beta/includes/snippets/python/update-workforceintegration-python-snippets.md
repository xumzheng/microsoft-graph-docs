...
requestBody.setSupports(WorkforceIntegrationSupportedEntities('supports-value'));



result = await client.teamwork().workforceIntegrationsById('workforceIntegration-id').patch(requestBody);
