...
requestConfiguration = CloudPcProvisioningPolicyRequestBuilderGetRequestConfiguration();

queryParameters = CloudPcProvisioningPolicyRequestBuilderGetQueryParameters();
