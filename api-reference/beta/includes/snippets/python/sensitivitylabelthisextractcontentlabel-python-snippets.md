...
result = await client.users._by_id('user-id').security.informationProtection.sensitivityLabels.securityextractContentLabel.post(request_body, request_config)
