...
request_body = Get_staff_availability_post_request_body()
request_body.StaffIds(['311a5454-08b2-4560-ba1c-f715e938cb79', ])

start_date_time = Date_time_time_zone()
...
end_date_time = Date_time_time_zone()
...
result = await client.solutions.booking_businesses.by_booking_businesse_id('bookingBusiness-id').get_staff_availability.post(request_body = request_body)
