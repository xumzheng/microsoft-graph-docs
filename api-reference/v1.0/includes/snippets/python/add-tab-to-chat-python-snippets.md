...
request_body.displayName = 'My Contoso Tab'
...
request_configuration = TabsRequestBuilderPostRequestConfiguration(
)


result = await client.chats_by_id('chat-id').tabs.post(request_body = request_body)
