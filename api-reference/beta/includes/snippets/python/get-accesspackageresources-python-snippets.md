...
request_config = AccessPackageResourcesRequestBuilderGetRequestConfiguration(query_params=params['filter'] = "resourceType eq 'Application'"
params['expand'] = ["accessPackageResourceScopes"]
)
