...
request_config = CustomTaskExtensionsRequestBuilderPostRequestConfiguration(
request_config = CustomTaskExtensionsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.identityGovernance.lifecycleWorkflows.customTaskExtensions.post(request_body, headers=)
