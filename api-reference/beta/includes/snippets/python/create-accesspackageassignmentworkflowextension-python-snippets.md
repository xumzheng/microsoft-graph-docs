...
result = await client.identityGovernance.entitlementManagement.accessPackageCatalogsby_id('accessPackageCatalog-id').accessPackageCustomWorkflowExtensions.post(request_body)
