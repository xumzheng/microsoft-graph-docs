...
<!-- { "blockType": "permissions", "name": "intune_onboarding_user_exportdeviceandappmanagementdata" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-onboarding-user-exportdeviceandappmanagementdata-permissions.md)]
