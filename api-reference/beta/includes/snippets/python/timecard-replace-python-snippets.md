...
'confirmedBy' => 'None', 
'notes' => 		null,
'clockInEvent' => requestBody = ClockInEvent();
...
'clockOutEvent' => requestBody = ClockOutEvent();
...
await client.teamsById('team-id').schedule().timeCardsById('timeCard-id').put(requestBody);
