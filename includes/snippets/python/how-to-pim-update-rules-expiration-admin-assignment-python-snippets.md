...
request_body.setId('Expiration_Admin_Assignment')
...
result = await client.policies.roleManagementPolicies._by_id('unifiedRoleManagementPolicy-id').rules._by_id('unifiedRoleManagementPolicyRule-id').patch(request_body)
