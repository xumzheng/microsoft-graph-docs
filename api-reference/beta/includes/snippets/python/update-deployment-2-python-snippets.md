...
request_config = DeploymentRequestBuilderPatchRequestConfiguration(
request_config = DeploymentRequestBuilderPatchRequestConfiguration(query_params=)


result = await client.admin.windows.updates.deployments_by_id('deployment-id').patch(request_body, headers=)
