...
request_config = EducationalActivityRequestBuilderPatchRequestConfiguration(
request_config = EducationalActivityRequestBuilderPatchRequestConfiguration(query_params=)


result = await client.me.profile.educationalActivities_by_id('educationalActivity-id').patch(request_body, headers=)
