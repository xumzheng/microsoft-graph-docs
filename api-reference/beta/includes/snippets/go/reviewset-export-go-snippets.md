...
graphClient.Compliance().Ediscovery().CasesById("case-id").ReviewSetsById("reviewSet-id").MicrosoftGraphEdiscoveryExport().Post(context.Background(), requestBody, nil)
