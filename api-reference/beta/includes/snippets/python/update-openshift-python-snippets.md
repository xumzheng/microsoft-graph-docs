...
request_config = OpenShiftRequestBuilderPutRequestConfiguration(
request_config = OpenShiftRequestBuilderPutRequestConfiguration(query_params=)


await client.teams_by_id('team-id').schedule.openShifts_by_id('openShift-id').put(request_body, headers=)
