...
request_config = TransferRequestBuilderPostRequestConfiguration(
request_config = TransferRequestBuilderPostRequestConfiguration(query_params=)


await client.communications.calls_by_id('call-id').transfer.post(request_body, headers=)
