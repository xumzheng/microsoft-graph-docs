...
request_config = EdiscoveryReviewSetQueryRequestBuilderPatchRequestConfiguration(
request_config = EdiscoveryReviewSetQueryRequestBuilderPatchRequestConfiguration(query_params=)
