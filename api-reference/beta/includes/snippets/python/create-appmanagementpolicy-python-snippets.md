...
request_config = AppManagementPoliciesRequestBuilderPostRequestConfiguration(
request_config = AppManagementPoliciesRequestBuilderPostRequestConfiguration(query_params=)


result = await client.policies.appManagementPolicies.post(request_body, headers=)
