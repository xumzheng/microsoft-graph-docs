...
request_config = CloudPcOnPremisesConnectionRequestBuilderGetRequestConfiguration(query_params=params['select'] = ["id","displayName","healthCheckStatus","healthCheckStatusDetails","inUse"]
)
