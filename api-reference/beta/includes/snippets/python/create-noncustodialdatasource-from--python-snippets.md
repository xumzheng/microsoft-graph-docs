...
await client.compliance.ediscovery.casesby_id('case-id').sourceCollectionsby_id('sourceCollection-id').noncustodialSourcesby_id('noncustodialDataSource-id').post(request_body)
