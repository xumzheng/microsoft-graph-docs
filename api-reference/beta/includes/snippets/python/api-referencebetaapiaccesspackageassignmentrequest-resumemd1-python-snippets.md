...
await client.identityGovernance.entitlementManagement.accessPackageAssignmentRequests._by_id('accessPackageAssignmentRequest-id').resume.post(request_body)
