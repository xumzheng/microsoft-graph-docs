...
result = await client.identityGovernance_lifecycleWorkflows_workflowsby_id('workflow-id')_taskReportsby_id('taskReport-id')_taskProcessingResults.get(request_config)
