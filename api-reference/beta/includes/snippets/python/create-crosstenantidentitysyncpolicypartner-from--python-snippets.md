...
await client.policies.crossTenantAccessPolicy.partners._by_id('crossTenantAccessPolicyConfigurationPartner-tenantId').identitySynchronization.put(request_body)
