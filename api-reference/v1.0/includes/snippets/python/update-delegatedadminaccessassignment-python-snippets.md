...
result = await client.tenantRelationships_delegatedAdminRelationshipsby_id('delegatedAdminRelationship-id')_accessAssignmentsby_id('delegatedAdminAccessAssignment-id').patch(request_body, request_config)
