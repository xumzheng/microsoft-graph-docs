...
request_configuration = AcronymRequestBuilderPatchRequestConfiguration(
)


result = await client.search.acronyms_by_id('acronym-id').patch(request_body = request_body)
