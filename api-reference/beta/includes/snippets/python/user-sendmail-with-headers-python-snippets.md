...
request_body = Send_mail_post_request_body()
message = Message()
message.subject = '9/9/2018: concert'

messagebody = Item_body()
...
to_recipients_recipient1email_address = Email_address()
...
internet_message_headers_internet_message_header1 = Internet_message_header()
...
internet_message_headers_internet_message_header2 = Internet_message_header()
