...
request_configuration = MarkChatReadForUserRequestBuilderPostRequestConfiguration(
)


await client.chats_by_id('chat-id').markChatReadForUser.post(request_body = request_body)
