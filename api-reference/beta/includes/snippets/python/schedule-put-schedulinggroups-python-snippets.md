...
await client.teams_by_id('team-id').schedule.schedulingGroups_by_id('schedulingGroup-id').put(request_body = request_body, request_configuration = request_configuration)
