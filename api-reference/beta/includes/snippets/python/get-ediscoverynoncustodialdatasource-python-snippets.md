...
result = await client.security.cases.ediscoveryCases._by_id('ediscoveryCase-id').noncustodialDataSources._by_id('ediscoveryNoncustodialDataSource-id').get(request_config)
