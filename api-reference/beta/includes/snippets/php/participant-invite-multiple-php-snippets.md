...
$participantsparticipants2 = new InvitationParticipantInfo();

$participantsparticipants2AdditionalData = [
"@odata.type" => '#microsoft.graph.invitationParticipantInfo',
"replacesCallId" => 'a7ebfb2d-871e-419c-87af-27290b22e8db',
];
$participantsparticipants2->setAdditionalData($participantsparticipants2AdditionalData);

$participantsArray []= $participantsparticipants2;
