...
request_config = PlansRequestBuilderPostRequestConfiguration(
request_config = PlansRequestBuilderPostRequestConfiguration(query_params=)


result = await client.planner.plans.post(request_body, headers=)
