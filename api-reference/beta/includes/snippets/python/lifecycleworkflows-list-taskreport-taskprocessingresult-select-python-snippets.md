...
result = await client.identityGovernance.lifecycleWorkflows.workflows_by_id('workflow-id').taskReports_by_id('taskReport-id').taskProcessingResults.get(request_configuration)
