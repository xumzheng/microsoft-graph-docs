...
result = await client.identity.conditionalAccess.authenticationStrengths.policiesby_id('authenticationStrengthPolicy-id').combinationConfigurations.post(request_body)
