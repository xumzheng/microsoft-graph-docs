...
request_body = Create_or_get_post_request_body()
...
attendees_meeting_participant_info1 = Meeting_participant_info()
attendees_meeting_participant_info1identity = Identity_set()
