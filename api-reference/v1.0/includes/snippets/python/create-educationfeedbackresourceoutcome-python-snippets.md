...
result = await client.education.classes._by_id('educationClass-id').assignments._by_id('educationAssignment-id').submissions._by_id('educationSubmission-id').outcomes.post(request_body)
