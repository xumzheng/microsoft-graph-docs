...
request_body.setTemplateId('62375ab9-6b52-47ed-826b-58e47e0e304b')
...
request_config = GroupSettingsRequestBuilderPostRequestConfiguration(
request_config = GroupSettingsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.groupSettings.post(request_body, headers=)
