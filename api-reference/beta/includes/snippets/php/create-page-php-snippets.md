...
$webPartswebParts1 = new WebPart();

$webPartswebParts1->setType('rte');

$data = new SitePageData();
$webPartswebParts1->setData($data);
...
$webPartsArray []= $webPartswebParts1;

$webPartswebParts2 = new WebPart();

$webPartswebParts2->setType('d1d91016-032f-456d-98a4-721247c305e8');

$data = new SitePageData();
$webPartswebParts2->setData($data);
...
$webPartsArray []= $webPartswebParts2;
