...
request_config = AccessAssignmentsRequestBuilderPostRequestConfiguration(
request_config = AccessAssignmentsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.tenantRelationships.delegatedAdminRelationships_by_id('delegatedAdminRelationship-id').accessAssignments.post(request_body, headers=)
