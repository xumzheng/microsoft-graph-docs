...
request_config = AppRoleAssignedResourcesRequestBuilderGetRequestConfiguration(query_params=query_params = AppRoleAssignedResourcesRequestBuilderGetQueryParameters()
