...
request_config = LearningProvidersRequestBuilderPostRequestConfiguration(
request_config = LearningProvidersRequestBuilderPostRequestConfiguration(query_params=)


result = await client.employeeExperience.learningProviders.post(request_body, headers=)
