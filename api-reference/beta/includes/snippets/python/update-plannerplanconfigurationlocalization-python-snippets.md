...
result = await client.solutions.businessScenarios._by_id('businessScenario-id').planner.planConfiguration.localizations._by_id('plannerPlanConfigurationLocalization-id').patch(request_body)
