...
request_configuration = UnifiedRoleDefinitionRequestBuilderPatchRequestConfiguration(
)


result = await client.roleManagement.directory.roleDefinitions_by_id('unifiedRoleDefinition-id').patch(request_body = request_body)
