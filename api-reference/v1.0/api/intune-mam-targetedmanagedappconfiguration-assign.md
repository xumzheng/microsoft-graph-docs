...
<!-- { "blockType": "permissions", "name": "intune_mam_targetedmanagedappconfiguration_assign" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-targetedmanagedappconfiguration-assign-permissions.md)]
