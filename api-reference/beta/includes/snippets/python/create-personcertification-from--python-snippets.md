...
request_config = CertificationsRequestBuilderPostRequestConfiguration(
request_config = CertificationsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.me.profile.certifications.post(request_body, headers=)
