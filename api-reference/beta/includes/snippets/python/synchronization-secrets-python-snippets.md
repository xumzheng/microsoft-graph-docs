...
request_config = SecretsRequestBuilderPutRequestConfiguration(
request_config = SecretsRequestBuilderPutRequestConfiguration(query_params=)


result = await client.servicePrincipals_by_id('servicePrincipal-id').synchronization.secrets.put(request_body, headers=)
