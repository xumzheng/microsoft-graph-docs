...
await client.security.cases.ediscoveryCasesby_id('ediscoveryCase-id').searchesby_id('ediscoverySearch-id').custodianSourcesby_id('dataSource-id').post(request_body)
