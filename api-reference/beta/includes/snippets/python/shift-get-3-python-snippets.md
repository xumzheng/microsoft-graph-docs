...
request_config = ShiftPreferencesRequestBuilderPutRequestConfiguration(
request_config = ShiftPreferencesRequestBuilderPutRequestConfiguration(query_params=)


await client.users_by_id('user-id').settings.shiftPreferences.put(request_body, headers=)
