...
request_config = AccessPackageRequestBuilderGetRequestConfiguration(query_params=params['expand'] = ["accessPackageResourceRoleScopes($expand=accessPackageResourceRole,accessPackageResourceScope)"]
)
