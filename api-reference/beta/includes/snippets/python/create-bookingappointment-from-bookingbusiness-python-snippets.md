...
request_body.customerLocation = customerLocation
...
request_body.optOutOfCustomerEmail = false
...
request_body.serviceLocation = serviceLocation
...
customQuestionAnswers1.isRequired = true
...
request_configuration = AppointmentsRequestBuilderPostRequestConfiguration(
)
