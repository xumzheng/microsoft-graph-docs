...
result = await client.identityGovernance.entitlementManagement.accessPackageAssignments_by_id('accessPackageAssignment-id').get(request_configuration = request_configuration)
