...
<!-- { "blockType": "permissions", "name": "reportroot_getbrowseruserdetail" } -->
[!INCLUDE [permissions-table](../includes/permissions/reportroot-getbrowseruserdetail-permissions.md)]
