...
request_configuration = EvaluateApplicationRequestBuilderPostRequestConfiguration(
request_configuration = EvaluateApplicationRequestBuilderPostRequestConfiguration(query_params=)
System.Collections.Generic.List`1[System.Tuple`2[System.String,System.String]])


result = await client.users_by_id('user-id').security.informationProtection.sensitivityLabels.securityevaluateApplication.post(request_body, request_configuration)
