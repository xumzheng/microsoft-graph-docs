...
result = await client.admin.edge.internetExplorerMode.siteLists._by_id('browserSiteList-id').sharedCookies._by_id('browserSharedCookie-id').patch(request_body)
