...
result = await client.identity_b2cUserFlowsby_id('b2cIdentityUserFlow-id')_userAttributeAssignmentsby_id('identityUserFlowAttributeAssignment-id').get(request_config)
