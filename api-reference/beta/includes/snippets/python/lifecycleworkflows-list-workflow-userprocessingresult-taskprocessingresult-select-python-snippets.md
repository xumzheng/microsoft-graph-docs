...
result = await client.identityGovernance.lifecycleWorkflows.workflows._by_id('workflow-id').userProcessingResults._by_id('userProcessingResult-id').taskProcessingResults.get(request_config)
