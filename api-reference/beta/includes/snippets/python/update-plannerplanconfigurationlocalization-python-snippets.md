...
result = await client.solutions.businessScenarios_by_id('businessScenario-id').planner.planConfiguration.localizations_by_id('plannerPlanConfigurationLocalization-id').patch(request_body)
