...
<!-- { "blockType": "permissions", "name": "intune_onboarding_deviceappmanagement_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-onboarding-deviceappmanagement-update-permissions.md)]
