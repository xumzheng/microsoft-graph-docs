...
request_config = SchemaRequestBuilderPutRequestConfiguration(
request_config = SchemaRequestBuilderPutRequestConfiguration(query_params=)


await client.servicePrincipals_by_id('servicePrincipal-id').synchronization.jobs_by_id('synchronizationJob-id').schema.put(request_body, headers=)
