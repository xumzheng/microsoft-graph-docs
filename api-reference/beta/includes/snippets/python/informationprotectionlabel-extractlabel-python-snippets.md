...
metadataKeyValuePair5.value = 'Top Secret'
...
result = await client.informationProtection.policy.labels.extractLabel.post(request_body = request_body, request_configuration = request_configuration)
