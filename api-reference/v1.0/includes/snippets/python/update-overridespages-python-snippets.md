...
await client.identity().b2xUserFlowsById('b2xIdentityUserFlow-id').languagesById('userFlowLanguageConfiguration-id').overridesPagesById('userFlowLanguagePage-id').value().put(request_body);
