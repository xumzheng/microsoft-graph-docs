...
request_config = PrintConnectorRequestBuilderPatchRequestConfiguration(
request_config = PrintConnectorRequestBuilderPatchRequestConfiguration(query_params=)


result = await client.print.connectors_by_id('printConnector-id').patch(request_body, headers=)
