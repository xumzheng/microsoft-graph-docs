...
request_config = BookingCustomerRequestBuilderPatchRequestConfiguration(
request_config = BookingCustomerRequestBuilderPatchRequestConfiguration(query_params=)
