...
Read the properties and relationships of an [employeeExperience](../resources/employeeexperience.md) object.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/employeeExperience
```
