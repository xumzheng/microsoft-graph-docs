...
request_config = EducationUserRequestBuilderPatchRequestConfiguration(
request_config = EducationUserRequestBuilderPatchRequestConfiguration(query_params=)


result = await client.education.users_by_id('educationUser-id').patch(request_body, headers=)
