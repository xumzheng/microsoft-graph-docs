...
request_config = LegalHoldsRequestBuilderPostRequestConfiguration(
request_config = LegalHoldsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.security.cases.ediscoveryCases_by_id('ediscoveryCase-id').legalHolds.post(request_body, headers=)
