...
request_body = Education_assignment()
request_body.dueDateTime = DateTime('2022-09-16T00:00:00Z')

request_body.display_name = 'Reading test 09.14'

instructions = Education_item_body()
...
grading = Education_assignment_grade_type()
...
assign_to = Education_assignment_recipient()
