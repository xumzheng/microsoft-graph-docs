...
request_config = WorkflowRequestBuilderGetRequestConfiguration(query_params=params['select'] = ["id","category","displayName","description","version","executionConditions"]
)
