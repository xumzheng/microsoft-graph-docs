...
| Teams [CallRecording](/graph/api/resources/callrecording) | <li> Any recording becomes available in the tenant: communications/onlineMeetings/getAllRecordings  <li>Any recording becomes available for a specific meeting: communications/onlineMeetings/getAllRecordings | Yes |
