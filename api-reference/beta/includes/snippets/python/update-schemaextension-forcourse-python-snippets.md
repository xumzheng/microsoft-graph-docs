...
request_config = SchemaExtensionRequestBuilderPatchRequestConfiguration(
request_config = SchemaExtensionRequestBuilderPatchRequestConfiguration(query_params=)


result = await client.schemaExtensions_by_id('schemaExtension-id').patch(request_body, headers=)
