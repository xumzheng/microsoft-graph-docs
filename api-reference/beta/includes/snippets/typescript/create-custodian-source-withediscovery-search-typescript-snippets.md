...
async () => {
	await graphServiceClient.security.cases.ediscoveryCasesById("ediscoveryCase-id").searchesById("ediscoverySearch-id").custodianSourcesById("dataSource-id").post(requestBody);
}
