...
await client.compliance_ediscovery_casesby_id('case-id')_sourceCollectionsby_id('sourceCollection-id')_noncustodialSourcesby_id('noncustodialDataSource-id').post(request_body)
