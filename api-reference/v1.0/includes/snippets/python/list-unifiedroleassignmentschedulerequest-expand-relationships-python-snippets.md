...
request_config = RoleAssignmentScheduleRequestsRequestBuilderGetRequestConfiguration(query_params=query_params = RoleAssignmentScheduleRequestsRequestBuilderGetQueryParameters()
