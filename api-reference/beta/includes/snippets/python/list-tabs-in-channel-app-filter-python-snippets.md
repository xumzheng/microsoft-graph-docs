...
request_config = TabsRequestBuilderGetRequestConfiguration(query_params=params['expand'] = ["teamsApp"]
params['filter'] = "teamsApp/id eq 'com.microsoft.teamspace.tab.planner'"
)
