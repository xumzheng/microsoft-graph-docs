...
graphClient.ServicePrincipalsById("servicePrincipal-id").Synchronization().JobsById("synchronizationJob-id").MicrosoftGraphRestart().Post(context.Background(), requestBody, configuration)
