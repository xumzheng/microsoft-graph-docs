...
result = awaitclient.identityGovernance().entitlementManagement().accessPackageCatalogsById('accessPackageCatalog-id').customAccessPackageWorkflowExtensions().post(requestBody);
