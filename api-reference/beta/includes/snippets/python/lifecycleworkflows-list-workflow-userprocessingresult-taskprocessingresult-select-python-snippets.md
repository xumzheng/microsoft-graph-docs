...
result = await client.identityGovernance.lifecycleWorkflows.workflowsById('workflow-id').userProcessingResultsById('userProcessingResult-id').taskProcessingResults.get(request_config)
