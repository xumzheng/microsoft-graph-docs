...
request_config = AccessPackageAssignmentRequestsRequestBuilderGetRequestConfiguration(query_params=query_params = AccessPackageAssignmentRequestsRequestBuilderGetQueryParameters()
