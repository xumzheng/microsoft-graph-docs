...
await client.security_cases_ediscoveryCasesby_id('ediscoveryCase-id')_searchesby_id('ediscoverySearch-id')_custodianSourcesby_id('dataSource-id').post(request_body)
