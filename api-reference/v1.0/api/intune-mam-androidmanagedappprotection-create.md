...
<!-- { "blockType": "permissions", "name": "intune_mam_androidmanagedappprotection_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-androidmanagedappprotection-create-permissions.md)]
