...
request_config = RetentionLabelRequestBuilderPatchRequestConfiguration(
request_config = RetentionLabelRequestBuilderPatchRequestConfiguration(query_params=)


result = await client.security.labels.retentionLabels_by_id('retentionLabel-id').patch(request_body, headers=)
