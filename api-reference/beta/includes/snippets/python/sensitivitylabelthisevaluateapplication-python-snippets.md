...
result = await client.users._by_id('user-id').security.informationProtection.sensitivityLabels.securityevaluateApplication.post(request_body, request_config)
