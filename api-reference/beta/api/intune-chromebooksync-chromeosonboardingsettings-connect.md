...
<!-- { "blockType": "permissions", "name": "intune_chromebooksync_chromeosonboardingsettings_connect" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-chromebooksync-chromeosonboardingsettings-connect-permissions.md)]
