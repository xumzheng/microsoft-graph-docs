...
'value' => request_body = Value()
		request_body.set@odatatype('#microsoft.graph.accessPackageAssignmentWorkflowExtension')

		request_body.setDisplayName('test_action_0127_email')
...
request_config = AccessPackageCustomWorkflowExtensionsRequestBuilderPostRequestConfiguration(
request_config = AccessPackageCustomWorkflowExtensionsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.identityGovernance.entitlementManagement.accessPackageCatalogs_by_id('accessPackageCatalog-id').accessPackageCustomWorkflowExtensions.post(request_body, headers=)
