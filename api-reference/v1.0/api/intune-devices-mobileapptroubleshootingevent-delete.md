...
<!-- { "blockType": "permissions", "name": "intune_devices_mobileapptroubleshootingevent_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-mobileapptroubleshootingevent-delete-permissions.md)]
