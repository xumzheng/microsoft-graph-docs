...
access_package_assignment = Access_package_assignment()
...
answers_access_package_answer1 = Access_package_answer()
answers_access_package_answer1.@odata_type = '#microsoft.graph.accessPackageAnswerString'

answers_access_package_answer1answered_question = Access_package_question()
...
answers_access_package_answer2 = Access_package_answer()
answers_access_package_answer2.@odata_type = '#microsoft.graph.accessPackageAnswerString'

answers_access_package_answer2answered_question = Access_package_question()
