...
default_location_address = PhysicalAddress()
...
request_body.default_location = defaultLocation
request_body.default_price = 10
...
result = await client.bookingBusinesses_by_id('bookingBusiness-id').services.post(request_body = request_body)
