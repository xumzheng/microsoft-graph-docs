...
request_config = PrivilegedApprovalRequestBuilderPostRequestConfiguration(
request_config = PrivilegedApprovalRequestBuilderPostRequestConfiguration(query_params=)


result = await client.privilegedApproval.post(request_body, headers=)
