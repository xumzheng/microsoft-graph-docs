...
result = await client.identityGovernance.lifecycleWorkflows.workflows._by_id('workflow-id').taskReports._by_id('taskReport-id').taskProcessingResults.get(request_config)
