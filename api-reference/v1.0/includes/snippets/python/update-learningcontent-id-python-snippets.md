...
request_body.setContributors(['Lina Wagner', 'Lisa Richter', ])
...
request_config = LearningContentRequestBuilderPatchRequestConfiguration(
request_config = LearningContentRequestBuilderPatchRequestConfiguration(query_params=)
