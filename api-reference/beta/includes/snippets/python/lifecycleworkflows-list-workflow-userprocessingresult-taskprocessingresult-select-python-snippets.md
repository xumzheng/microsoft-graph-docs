...
result = await client.identityGovernance_lifecycleWorkflows_workflowsby_id('workflow-id')_userProcessingResultsby_id('userProcessingResult-id')_taskProcessingResults.get(request_config)
