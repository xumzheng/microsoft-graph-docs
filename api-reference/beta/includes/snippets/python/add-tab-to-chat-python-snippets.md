...
request_config = TabsRequestBuilderPostRequestConfiguration(
request_config = TabsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.chats_by_id('chat-id').tabs.post(request_body, headers=)
