...
request_config = TeamRequestBuilderPutRequestConfiguration(
request_config = TeamRequestBuilderPutRequestConfiguration(query_params=)


result = await client.groups_by_id('group-id').team.put(request_body, headers=)
