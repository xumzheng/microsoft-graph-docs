...
<!-- { "blockType": "permissions", "name": "intune_rbac_operationapprovalrequest_cancelapproval" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-rbac-operationapprovalrequest-cancelapproval-permissions.md)]
