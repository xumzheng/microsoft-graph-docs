...
request_config = ServicePrincipalRiskDetectionsRequestBuilderGetRequestConfiguration(query_params=query_params = ServicePrincipalRiskDetectionsRequestBuilderGetQueryParameters()
