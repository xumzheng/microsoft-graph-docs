...
result = await client.identityGovernance.entitlementManagement.accessPackageCatalogsby_id('accessPackageCatalog-id').accessPackageResourceRoles.get(request_config)
