...
result = await client.identityGovernance.entitlementManagement.accessPackageCatalogsById('accessPackageCatalog-id').accessPackageCustomWorkflowExtensions.post(request_body);
