...
request_configuration = TimeOffRequestBuilderPutRequestConfiguration(query_params=)
System.Collections.Generic.List`1[System.Tuple`2[System.String,System.String]])


await client.teams_by_id('team-id').schedule.timesOff_by_id('timeOff-id').put(request_body, request_configuration)
