...
result = await client.identityGovernance.entitlementManagement.accessPackageCatalogs._by_id('accessPackageCatalog-id').accessPackageResourceRoles.get(request_config)
