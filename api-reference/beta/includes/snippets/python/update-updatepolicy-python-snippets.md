...
request_config = UpdatePolicyRequestBuilderPatchRequestConfiguration(
request_config = UpdatePolicyRequestBuilderPatchRequestConfiguration(query_params=)


result = await client.admin.windows.updates.updatePolicies_by_id('updatePolicy-id').patch(request_body, headers=)
