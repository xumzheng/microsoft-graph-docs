...
var requestBody = new ConditionalAccessPolicy
{
	...
	Conditions = new ConditionalAccessConditionSet
	{
		...
		Applications = new ConditionalAccessApplications
		{
			...
			IncludeUserActions = new List<>
			{
			},
		},
		Users = new ConditionalAccessUsers
		{
			IncludeUsers = new List<>
			{
				"a702a13d-a437-4a07-8a7e-8c052de62dfd",
			},
			ExcludeUsers = new List<>
			{
			...
			ExcludeGroups = new List<>
			{
			},
			IncludeRoles = new List<>
			{
				"9b895d92-2cd3-44c7-9d02-a6ac2d5ea5c3",
				"cf1c38e5-3621-4004-a7cb-879624dced7c",
				"c4e39bd9-1100-46d3-8c65-fb160da0071f",
			},
			ExcludeRoles = new List<>
			{
		...
		{
			IncludePlatforms = new List<>
			{
				"all",
			},
			ExcludePlatforms = new List<>
			{
				"iOS",
				"windowsPhone",
			},
		...
		{
			IncludeStates = new List<>
			{
				"All",
			},
			ExcludeStates = new List<>
			{
				"Compliant",
			},
		},
	...
	GrantControls = new ConditionalAccessGrantControls
	{
		...
		CustomAuthenticationFactors = new List<>
		{
		},
		TermsOfUse = new List<>
		{
	...
	SessionControls = new ConditionalAccessSessionControls
	{
		...
		CloudAppSecurity = new CloudAppSecurity
		{
			CloudAppSecurityType = CloudAppSecuritySessionControlType.Blockdownloads,
			IsEnabled = true,
		},
		SignInFrequency = new SignInFrequency
		{
			Value = 4,
