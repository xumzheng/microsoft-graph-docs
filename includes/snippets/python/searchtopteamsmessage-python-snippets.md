...
request_config = QueryRequestBuilderPostRequestConfiguration(
request_config = QueryRequestBuilderPostRequestConfiguration(query_params=)


result = await client.search.query.post(request_body, headers=)
