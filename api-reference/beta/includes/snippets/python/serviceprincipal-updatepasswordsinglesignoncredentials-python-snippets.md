...
request_configuration = UpdatePasswordSingleSignOnCredentialsRequestBuilderPostRequestConfiguration(
)


await client.servicePrincipals_by_id('servicePrincipal-id').updatePasswordSingleSignOnCredentials.post(request_body = request_body)
