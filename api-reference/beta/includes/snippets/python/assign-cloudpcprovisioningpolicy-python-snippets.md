...
request_config = AssignRequestBuilderPostRequestConfiguration(
request_config = AssignRequestBuilderPostRequestConfiguration(query_params=)


await client.deviceManagement.virtualEndpoint.provisioningPolicies_by_id('cloudPcProvisioningPolicy-id').assign.post(request_body, headers=)
