...
attendeesMeetingParticipantInfo1.setRole(OnlineMeetingRole('presenter'))
...
request_config = CreateOrGetRequestBuilderPostRequestConfiguration(
request_config = CreateOrGetRequestBuilderPostRequestConfiguration(query_params=)


result = await client.me.onlineMeetings.createOrGet.post(request_body, headers=)
