...
result = await client.identityGovernance.entitlementManagement.accessPackageCatalogs._by_id('accessPackageCatalog-id').customAccessPackageWorkflowExtensions.post(request_body)
