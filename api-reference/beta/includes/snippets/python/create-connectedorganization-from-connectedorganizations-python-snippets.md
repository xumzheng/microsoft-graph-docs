...
request_config = ConnectedOrganizationsRequestBuilderPostRequestConfiguration(
request_config = ConnectedOrganizationsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.identityGovernance.entitlementManagement.connectedOrganizations.post(request_body, headers=)
