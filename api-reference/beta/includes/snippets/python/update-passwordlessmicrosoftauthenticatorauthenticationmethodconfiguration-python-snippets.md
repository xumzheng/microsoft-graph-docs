...
request_body = Authentication_method_configuration()
request_body.@odata_type = '#microsoft.graph.passwordlessMicrosoftAuthenticatorAuthenticationMethodConfiguration'
