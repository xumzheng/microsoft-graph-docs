...
request_body.setDisplayName('Reading test 09.14')
...
request_config = AssignmentsRequestBuilderPostRequestConfiguration(
request_config = AssignmentsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.education.classes_by_id('educationClass-id').assignments.post(request_body, headers=)
