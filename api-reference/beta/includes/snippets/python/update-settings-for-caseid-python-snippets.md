...
// THE PYTHON SDK IS IN PREVIEW. NON-PRODUCTION USE ONLY$requestBody = new CaseSettings();
...
$requestResult = $graphServiceClient->compliance()->ediscovery()->casesById('case-id')->settings()->patch($requestBody);
