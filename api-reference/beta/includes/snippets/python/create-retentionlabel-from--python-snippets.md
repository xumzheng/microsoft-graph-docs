...
request_config = RetentionLabelsRequestBuilderPostRequestConfiguration(
request_config = RetentionLabelsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.security.labels.retentionLabels.post(request_body, headers=)
