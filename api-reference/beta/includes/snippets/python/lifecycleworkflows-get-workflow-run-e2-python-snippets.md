...
request_config = RunRequestBuilderGetRequestConfiguration(query_params=params['select'] = ["id","failedTasksCount","failedUsersCount","processingStatus","totalTasksCount","totalUnprocessedTasksCount","totalUsersCount"]
)
