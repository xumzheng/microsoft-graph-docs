...
request_body = Extract_label_post_request_body()
...
metadata_key_value_pair5.value = 'Top Secret'
...
result = await client.information_protection.policy.labels.extract_label.post(request_body = request_body, request_configuration = request_configuration)
