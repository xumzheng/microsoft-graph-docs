...
request_config = KeySetsRequestBuilderPostRequestConfiguration(
request_config = KeySetsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.trustFramework.keySets.post(request_body, headers=)
