...
{
	requestConfiguration.QueryParameters.Filter = "resourceType%20eq%20'Application'";
	requestConfiguration.QueryParameters.Expand = new [] { "accessPackageResourceScopes" };
});
