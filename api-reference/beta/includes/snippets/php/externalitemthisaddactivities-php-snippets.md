...
$requestResult = $graphServiceClient->connectionsById('externalConnection-id')->itemsById('externalItem-id')->microsoftGraphExternalConnectorsAddActivities()->post($requestBody);
