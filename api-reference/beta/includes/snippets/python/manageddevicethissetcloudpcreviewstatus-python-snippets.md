...
request_config = SetCloudPcReviewStatusRequestBuilderPostRequestConfiguration(
request_config = SetCloudPcReviewStatusRequestBuilderPostRequestConfiguration(query_params=)


await client.deviceManagement.managedDevices_by_id('managedDevice-id').setCloudPcReviewStatus.post(request_body, headers=)
