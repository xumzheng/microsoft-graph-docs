...
request_config = SubjectRightsRequestsRequestBuilderPostRequestConfiguration(
request_config = SubjectRightsRequestsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.privacy.subjectRightsRequests.post(request_body, headers=)
