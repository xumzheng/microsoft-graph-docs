...
await client.security.cases.ediscoveryCases._by_id('ediscoveryCase-id').searches._by_id('ediscoverySearch-id').custodianSources._by_id('dataSource-id').post(request_body)
