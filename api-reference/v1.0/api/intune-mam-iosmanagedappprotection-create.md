...
<!-- { "blockType": "permissions", "name": "intune_mam_iosmanagedappprotection_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-iosmanagedappprotection-create-permissions.md)]
