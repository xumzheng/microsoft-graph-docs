...
result = await client.policies.crossTenantAccessPolicy.partnersby_id('crossTenantAccessPolicyConfigurationPartner-tenantId').identitySynchronization.patch(request_body)
