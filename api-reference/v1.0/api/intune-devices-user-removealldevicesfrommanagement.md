...
<!-- { "blockType": "permissions", "name": "intune_devices_user_removealldevicesfrommanagement" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-user-removealldevicesfrommanagement-permissions.md)]
