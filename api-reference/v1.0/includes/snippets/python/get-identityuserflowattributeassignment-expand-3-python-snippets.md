...
result = await client.identity.b2xUserFlowsby_id('b2xIdentityUserFlow-id').userAttributeAssignmentsby_id('identityUserFlowAttributeAssignment-id').get(request_config)
