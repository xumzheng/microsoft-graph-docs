...
<!-- { "blockType": "permissions", "name": "reportroot_getteamsuseractivitytotalusercounts" } -->
[!INCLUDE [permissions-table](../includes/permissions/reportroot-getteamsuseractivitytotalusercounts-permissions.md)]
