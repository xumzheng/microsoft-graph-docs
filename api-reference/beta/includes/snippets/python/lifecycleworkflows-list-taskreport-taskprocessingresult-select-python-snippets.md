...
result = await client.identityGovernance.lifecycleWorkflows.workflowsby_id('workflow-id').taskReportsby_id('taskReport-id').taskProcessingResults.get(request_config)
