...
request_config = CloudPcProvisioningPolicyRequestBuilderPatchRequestConfiguration(
request_config = CloudPcProvisioningPolicyRequestBuilderPatchRequestConfiguration(query_params=)


result = await client.deviceManagement.virtualEndpoint.provisioningPolicies_by_id('cloudPcProvisioningPolicy-id').patch(request_body, headers=)
