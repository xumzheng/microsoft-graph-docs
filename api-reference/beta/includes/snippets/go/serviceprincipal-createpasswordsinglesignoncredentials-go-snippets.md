...
result, err := graphClient.ServicePrincipalsById("servicePrincipal-id").MicrosoftGraphCreatePasswordSingleSignOnCredentials().Post(context.Background(), requestBody, nil)
