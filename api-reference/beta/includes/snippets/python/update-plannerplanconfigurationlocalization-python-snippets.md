...
result = await client.solutions.businessScenariosby_id('businessScenario-id').planner.planConfiguration.localizationsby_id('plannerPlanConfigurationLocalization-id').patch(request_body)
