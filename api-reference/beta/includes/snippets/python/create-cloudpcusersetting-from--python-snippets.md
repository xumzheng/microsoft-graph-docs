...
request_config = UserSettingsRequestBuilderPostRequestConfiguration(
request_config = UserSettingsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.deviceManagement.virtualEndpoint.userSettings.post(request_body, headers=)
