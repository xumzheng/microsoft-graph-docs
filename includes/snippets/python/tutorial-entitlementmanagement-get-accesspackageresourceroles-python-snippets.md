...
request_config = AccessPackageResourceRolesRequestBuilderGetRequestConfiguration(query_params=params['filter'] = "(originSystem eq 'AadGroup' and accessPackageResource/id eq '4a1e21c5-8a76-4578-acb1-641160e076e8' and displayName eq 'Member')"
