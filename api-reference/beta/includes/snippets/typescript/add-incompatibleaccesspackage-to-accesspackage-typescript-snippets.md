...
async () => {
	await graphServiceClient.identityGovernance.entitlementManagement.accessPackagesById("accessPackage-id").incompatibleAccessPackagesById("accessPackage-id1").post(requestBody);
}
