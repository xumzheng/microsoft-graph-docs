...
request_configuration = RunHuntingQueryRequestBuilderPostRequestConfiguration(
)


result = await client.security.securityrunHuntingQuery.post(request_body = request_body)
