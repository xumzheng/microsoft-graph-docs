...
request_configuration = EvaluateRemovalRequestBuilderPostRequestConfiguration(
request_configuration = EvaluateRemovalRequestBuilderPostRequestConfiguration(query_params=)
System.Collections.Generic.List`1[System.Tuple`2[System.String,System.String]])


result = await client.users_by_id('user-id').security.informationProtection.sensitivityLabels.securityevaluateRemoval.post(request_body, request_configuration)
