...
request_config = UserAttributeAssignmentsRequestBuilderPostRequestConfiguration(
request_config = UserAttributeAssignmentsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.identity.b2xUserFlows_by_id('b2xIdentityUserFlow-id').userAttributeAssignments.post(request_body, headers=)
