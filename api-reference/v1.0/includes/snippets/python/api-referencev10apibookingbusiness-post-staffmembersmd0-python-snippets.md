...
workingHours1.timeslots(timeSlotsArray)
...
request_configuration = StaffMembersRequestBuilderPostRequestConfiguration(
)


result = await client.solutions.bookingBusinesses_by_id('bookingBusiness-id').staffMembers.post(request_body = request_body)
