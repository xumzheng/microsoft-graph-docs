...
result = await client.planner.tasks_by_id('plannerTask-id').bucketTaskBoardFormat.patch(request_body = request_body, request_configuration = request_configuration)
