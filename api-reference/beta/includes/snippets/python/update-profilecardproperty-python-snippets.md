...
request_config = ProfileCardPropertyRequestBuilderPatchRequestConfiguration(
request_config = ProfileCardPropertyRequestBuilderPatchRequestConfiguration(query_params=)
