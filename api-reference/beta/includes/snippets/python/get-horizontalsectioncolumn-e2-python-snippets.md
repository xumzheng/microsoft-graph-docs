...
request_config = HorizontalSectionColumnRequestBuilderGetRequestConfiguration(query_params=query_params = HorizontalSectionColumnRequestBuilderGetQueryParameters()
