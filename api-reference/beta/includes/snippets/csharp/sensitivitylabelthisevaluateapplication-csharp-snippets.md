...
var result = await graphClient.Users["user-id"].Security.InformationProtection.SensitivityLabels.EvaluateApplication.PostAsync(requestBody, (requestConfiguration) =>
{
