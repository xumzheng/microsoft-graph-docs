...
1. Create a new pipeline by selecting the **plus** icon, then **pipeline**.
    ...
    1. In the dialog that appears, select the integration runtime generated by the default auto-resolve.
