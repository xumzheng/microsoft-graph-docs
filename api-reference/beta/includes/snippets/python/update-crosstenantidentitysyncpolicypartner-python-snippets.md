...
request_config = IdentitySynchronizationRequestBuilderPatchRequestConfiguration(
request_config = IdentitySynchronizationRequestBuilderPatchRequestConfiguration(query_params=)
