...
request_body = Update_alerts_post_request_body()
value_alert1 = Alert()
...
value_alert1feedback = Alert_feedback()
additional_data = [
...
value_alert1status = Alert_status()
additional_data = [
...
value_alert1vendor_information = Security_vendor_information()
