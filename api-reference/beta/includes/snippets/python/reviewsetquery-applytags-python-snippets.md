...
await client.compliance.ediscovery.casesby_id('case-id').reviewSetsby_id('reviewSet-id').queriesby_id('reviewSetQuery-id').ediscoveryapplyTags.post(request_body)
