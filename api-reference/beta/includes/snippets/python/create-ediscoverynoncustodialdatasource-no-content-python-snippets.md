...
await client.security.cases.ediscoveryCases_by_id('ediscoveryCase-id').searches_by_id('ediscoverySearch-id').noncustodialSources_by_id('ediscoveryNoncustodialDataSource-id').post(request_body)
