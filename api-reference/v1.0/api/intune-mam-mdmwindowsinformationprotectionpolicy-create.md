...
<!-- { "blockType": "permissions", "name": "intune_mam_mdmwindowsinformationprotectionpolicy_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-mdmwindowsinformationprotectionpolicy-create-permissions.md)]
