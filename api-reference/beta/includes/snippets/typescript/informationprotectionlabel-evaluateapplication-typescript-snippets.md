...
const requestBody = new EvaluateApplicationRequestBody();
...
requestBody.labelingOptions.assignmentMethod = AssignmentMethod.Standard;
...
requestBody.labelingOptions.additionalData = {
