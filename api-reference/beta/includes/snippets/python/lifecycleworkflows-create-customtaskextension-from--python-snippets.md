...
callbackConfiguration.timeoutduration =  \DateInterval('PT5M')


request_body.callbackConfiguration = callbackConfiguration


request_configuration = CustomTaskExtensionsRequestBuilderPostRequestConfiguration(
)


result = await client.identityGovernance.lifecycleWorkflows.customTaskExtensions.post(request_body = request_body)
