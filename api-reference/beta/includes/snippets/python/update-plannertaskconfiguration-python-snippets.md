...
request_config = TaskConfigurationRequestBuilderPatchRequestConfiguration(
request_config = TaskConfigurationRequestBuilderPatchRequestConfiguration(query_params=)


result = await client.solutions.businessScenarios_by_id('businessScenario-id').planner.taskConfiguration.patch(request_body, headers=)
