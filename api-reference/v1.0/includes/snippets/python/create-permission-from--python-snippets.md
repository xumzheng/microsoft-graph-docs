...
request_config = PermissionsRequestBuilderPostRequestConfiguration(
request_config = PermissionsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.sites_by_id('site-id').permissions.post(request_body, headers=)
