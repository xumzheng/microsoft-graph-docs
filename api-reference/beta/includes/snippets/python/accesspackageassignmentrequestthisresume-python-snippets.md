...
await client.identityGovernance_entitlementManagement_accessPackageAssignmentRequestsby_id('accessPackageAssignmentRequest-id')_resume.post(request_body)
