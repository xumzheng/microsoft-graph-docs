...
request_body = Unified_role_management_policy_rule()
...
target = Unified_role_management_policy_rule_target()
...
additional_data = [
'enabled_rules' => ['Justification', 'MultiFactorAuthentication', ],
];
