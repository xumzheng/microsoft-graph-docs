...
request_config = FederatedIdentityCredentialRequestBuilderPatchRequestConfiguration(
request_config = FederatedIdentityCredentialRequestBuilderPatchRequestConfiguration(query_params=)


result = await client.applications_by_id('application-id').federatedIdentityCredentials_by_id('federatedIdentityCredential-id').patch(request_body, headers=)
