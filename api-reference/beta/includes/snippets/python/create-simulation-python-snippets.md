...
request_config = SimulationsRequestBuilderPostRequestConfiguration(
request_config = SimulationsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.security.attackSimulation.simulations.post(request_body, headers=)
