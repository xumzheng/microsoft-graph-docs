...
request_config = ProgramControlsRequestBuilderPostRequestConfiguration(
request_config = ProgramControlsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.programControls.post(request_body, headers=)
