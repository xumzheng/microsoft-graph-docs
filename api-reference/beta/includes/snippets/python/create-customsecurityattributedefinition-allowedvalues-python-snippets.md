...
request_body = Custom_security_attribute_definition()
...
allowed_values_allowed_value1 = Allowed_value()
...
allowed_values_allowed_value2 = Allowed_value()
...
allowed_values_allowed_value3 = Allowed_value()
