...
request_config = ConversationsRequestBuilderPostRequestConfiguration(
request_config = ConversationsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.groups_by_id('group-id').conversations.post(request_body, headers=)
