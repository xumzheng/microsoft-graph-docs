...
await client.security.cases.ediscoveryCases_by_id('ediscoveryCase-id').searches_by_id('ediscoverySearch-id').custodianSources_by_id('dataSource-id').post(request_body, headers=)
