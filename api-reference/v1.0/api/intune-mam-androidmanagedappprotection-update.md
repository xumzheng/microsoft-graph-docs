...
<!-- { "blockType": "permissions", "name": "intune_mam_androidmanagedappprotection_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-androidmanagedappprotection-update-permissions.md)]
