...
<!-- { "blockType": "permissions", "name": "intune_devices_manageddevice_disable" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-manageddevice-disable-permissions.md)]
