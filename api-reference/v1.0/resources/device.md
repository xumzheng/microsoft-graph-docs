...
|memberOf|[directoryObject](directoryobject.md) collection|Groups adn administrative units that this device is a member of. Read-only. Nullable. Supports `$expand`. |
