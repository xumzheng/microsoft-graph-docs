...
result = await client.identityGovernance().entitlementManagement().accessPackageCatalogsById('accessPackageCatalog-id').customAccessPackageWorkflowExtensions().post(request_body);
