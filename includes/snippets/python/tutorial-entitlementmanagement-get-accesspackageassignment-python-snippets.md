...
request_config = AccessPackageAssignmentsRequestBuilderGetRequestConfiguration(query_params=query_params = AccessPackageAssignmentsRequestBuilderGetQueryParameters()
