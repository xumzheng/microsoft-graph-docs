...
requestBody.setType(CloudPcOnPremisesConnectionType('hybridazureadjoin'));
...
result = await client.deviceManagement().virtualEndpoint().onPremisesConnections().post(requestBody);
