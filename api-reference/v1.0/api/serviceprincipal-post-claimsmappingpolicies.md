...
<!-- { "blockType": "permissions", "name": "serviceprincipal_post_claimsmappingpolicies" } -->
[!INCLUDE [permissions-table](../includes/permissions/serviceprincipal-post-claimsmappingpolicies-permissions.md)]
