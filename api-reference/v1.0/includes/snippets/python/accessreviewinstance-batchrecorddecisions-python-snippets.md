...
await client.identityGovernance.accessReviews.definitionsby_id('accessReviewScheduleDefinition-id').instancesby_id('accessReviewInstance-id').batchRecordDecisions.post(request_body)
