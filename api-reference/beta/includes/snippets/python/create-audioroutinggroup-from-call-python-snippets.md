...
request_config = AudioRoutingGroupsRequestBuilderPostRequestConfiguration(
request_config = AudioRoutingGroupsRequestBuilderPostRequestConfiguration(query_params=)
