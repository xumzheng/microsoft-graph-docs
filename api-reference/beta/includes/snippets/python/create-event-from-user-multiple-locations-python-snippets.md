...
attendees_attendee1email_address = Email_address()
...
attendees_attendee2email_address = Email_address()
...
locations_location2address = Physical_address()
...
locations_location2coordinates = Outlook_geo_coordinates()
