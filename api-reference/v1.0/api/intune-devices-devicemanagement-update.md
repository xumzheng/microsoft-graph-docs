...
<!-- { "blockType": "permissions", "name": "intune_devices_devicemanagement_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-devicemanagement-update-permissions.md)]
