...
await client.security.cases.ediscoveryCases_by_id('ediscoveryCase-id').reviewSets_by_id('ediscoveryReviewSet-id').queries_by_id('ediscoveryReviewSetQuery-id').securityapplyTags.post(request_body)
