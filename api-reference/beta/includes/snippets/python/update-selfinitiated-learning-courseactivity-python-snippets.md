...
request_body = Learning_course_activity()
...
result = await client.employee_experience.learning_course_activities.by_learning_course_activitie_id('learningCourseActivity-id').patch(request_body = request_body)
