...
request_config = DefaultRequestBuilderPatchRequestConfiguration(
request_config = DefaultRequestBuilderPatchRequestConfiguration(query_params=)


result = await client.policies.crossTenantAccessPolicy.default.patch(request_body, headers=)
