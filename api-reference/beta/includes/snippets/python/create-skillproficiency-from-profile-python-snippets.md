...
request_config = SkillsRequestBuilderPostRequestConfiguration(
request_config = SkillsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.me.profile.skills.post(request_body, headers=)
