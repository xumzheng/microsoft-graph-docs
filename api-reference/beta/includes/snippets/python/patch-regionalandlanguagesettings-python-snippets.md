...
request_config = RegionalAndLanguageSettingsRequestBuilderPatchRequestConfiguration(
request_config = RegionalAndLanguageSettingsRequestBuilderPatchRequestConfiguration(query_params=)


result = await client.me.settings.regionalAndLanguageSettings.patch(request_body, headers=)
