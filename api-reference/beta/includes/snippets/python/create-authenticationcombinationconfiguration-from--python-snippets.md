...
result = await client.identity_conditionalAccess_authenticationStrengths_policiesby_id('authenticationStrengthPolicy-id')_combinationConfigurations.post(request_body)
