...
await client.security().cases().ediscoveryCasesById('ediscoveryCase-id').searchesById('ediscoverySearch-id').custodianSourcesById('dataSource-id').post(requestBody);
