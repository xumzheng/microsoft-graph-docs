...
$attributesattributes1 = new AccessPackageResourceAttribute();

$attributesattributes1->setAttributeName('extension_2b676109c7c74ae2b41549205f1947ed_personalTitle');
$attributesattributes1->setIsEditable(True);
$attributesattributes1->setIsPersistedOnAssignmentRemoval(True);

$attributeSource = new AccessPackageResourceAttributeSource();
$attributesattributes1->setAttributeSource($attributeSource);
...
$attributesattributes1->setAttributeDestination($attributeDestination);
...
$attributesArray []= $attributesattributes1;
