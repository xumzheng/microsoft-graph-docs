...
result = await client.education.classesby_id('educationClass-id').assignmentsby_id('educationAssignment-id').submissionsby_id('educationSubmission-id').resources.post(request_body)
