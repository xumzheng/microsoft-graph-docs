...
request_config = AddressesRequestBuilderPostRequestConfiguration(
request_config = AddressesRequestBuilderPostRequestConfiguration(query_params=)


result = await client.me.profile.addresses.post(request_body, headers=)
