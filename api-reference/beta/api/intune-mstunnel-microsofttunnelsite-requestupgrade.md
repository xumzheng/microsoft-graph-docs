...
<!-- { "blockType": "permissions", "name": "intune_mstunnel_microsofttunnelsite_requestupgrade" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mstunnel-microsofttunnelsite-requestupgrade-permissions.md)]
