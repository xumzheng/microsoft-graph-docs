...
request_body = Tenant_app_management_policy()
request_body.is_enabled = True

application_restrictions = App_management_configuration()
...
password_credentials_password_credential_configuration5 = Password_credential_configuration()
