...
request_configuration = CheckMemberGroupsRequestBuilderPostRequestConfiguration(
)


result = await client.directoryObjects_by_id('directoryObject-id').checkMemberGroups.post(request_body = request_body)
