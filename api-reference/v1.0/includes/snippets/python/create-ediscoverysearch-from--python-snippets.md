...
request_body.displayName = 'My search 2'
...
request_configuration = SearchesRequestBuilderPostRequestConfiguration(
)


result = await client.security.cases.ediscoveryCases_by_id('ediscoveryCase-id').searches.post(request_body = request_body)
