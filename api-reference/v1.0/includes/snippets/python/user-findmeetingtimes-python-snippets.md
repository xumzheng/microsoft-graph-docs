...
request_body = Find_meeting_times_post_request_body()
attendees_attendee_base1 = Attendee_base()
attendees_attendee_base1.type(AttendeeType.Required('attendeetype.required'))

attendees_attendee_base1email_address = Email_address()
...
locations_location_constraint_item1 = Location_constraint_item()
...
time_slots_time_slot1 = Time_slot()
time_slots_time_slot1start = Date_time_time_zone()
...
time_slots_time_slot1end = Date_time_time_zone()
