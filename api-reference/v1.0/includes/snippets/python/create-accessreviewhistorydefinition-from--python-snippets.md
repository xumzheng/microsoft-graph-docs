...
request_config = HistoryDefinitionsRequestBuilderPostRequestConfiguration(
request_config = HistoryDefinitionsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.identityGovernance.accessReviews.historyDefinitions.post(request_body, headers=)
