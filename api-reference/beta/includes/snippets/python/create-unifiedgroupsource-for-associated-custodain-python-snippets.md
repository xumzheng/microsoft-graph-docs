...
result = await client.security.cases.ediscoveryCasesby_id('ediscoveryCase-id').custodiansby_id('ediscoveryCustodian-id').unifiedGroupSources.post(request_body)
