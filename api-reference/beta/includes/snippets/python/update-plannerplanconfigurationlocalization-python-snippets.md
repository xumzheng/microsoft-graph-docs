...
result = await client.solutions_businessScenariosby_id('businessScenario-id')_planner_planConfiguration_localizationsby_id('plannerPlanConfigurationLocalization-id').patch(request_body)
