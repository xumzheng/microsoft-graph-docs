...
request_config = SendActivityNotificationToRecipientsRequestBuilderPostRequestConfiguration(
request_config = SendActivityNotificationToRecipientsRequestBuilderPostRequestConfiguration(query_params=)


await client.teamwork.sendActivityNotificationToRecipients.post(request_body, headers=)
