...
request_body = Transfer_post_request_body()
transfer_target = Invitation_participant_info()
transfer_target.endpointtype(EndpointType.Default('endpointtype.default'))

transfer_targetidentity = Identity_set()
...
transferee = Participant_info()
transfereeidentity = Identity_set()
