...
<!-- { "blockType": "permissions", "name": "intune_mam_targetedmanagedappconfiguration_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-targetedmanagedappconfiguration-update-permissions.md)]
