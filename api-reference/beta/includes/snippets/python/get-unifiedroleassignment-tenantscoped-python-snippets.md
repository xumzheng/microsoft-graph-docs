...
request_config = TransitiveRoleAssignmentsRequestBuilderGetRequestConfiguration(query_params=query_params = TransitiveRoleAssignmentsRequestBuilderGetQueryParameters()
