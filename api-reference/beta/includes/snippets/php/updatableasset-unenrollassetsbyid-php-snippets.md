...
$requestRequestBody = new UnenrollAssetsByIdPostRequestBody();
...
$result =  $graphClient->admin()->windows()->updates()->updatableAssets()->unenrollAssetsById()->post($requestRequestBody);
