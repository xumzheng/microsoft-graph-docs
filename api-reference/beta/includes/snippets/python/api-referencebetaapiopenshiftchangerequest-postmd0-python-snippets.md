...
request_config = OpenShiftChangeRequestsRequestBuilderPostRequestConfiguration(query_params=)
System.Collections.Generic.List`1[System.Tuple`2[System.String,System.String]])


result = await client.teams_by_id('team-id').schedule.openShiftChangeRequests.post(request_body, request_config, headers=request_config)
