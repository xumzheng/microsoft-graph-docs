...
result = await client.identity_b2xUserFlowsby_id('b2xIdentityUserFlow-id')_userAttributeAssignmentsby_id('identityUserFlowAttributeAssignment-id').get(request_config)
