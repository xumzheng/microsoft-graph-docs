...
request_config = UnifiedRoleAssignmentMultipleRequestBuilderGetRequestConfiguration(query_params=params['expand'] = ["roleDefinition","principals","directoryScopes"]
)
