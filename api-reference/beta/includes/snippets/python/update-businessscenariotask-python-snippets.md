...
request_config = BusinessScenarioTaskRequestBuilderPatchRequestConfiguration(
request_config = BusinessScenarioTaskRequestBuilderPatchRequestConfiguration(query_params=)
