...
await client.identity.b2cUserFlowsby_id('b2cIdentityUserFlow-id').languagesby_id('userFlowLanguageConfiguration-id').overridesPagesby_id('userFlowLanguagePage-id').content.put(request_body)
