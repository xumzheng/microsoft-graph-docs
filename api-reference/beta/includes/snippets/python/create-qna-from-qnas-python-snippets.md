...
requestBody.setAvailabilityStartDateTime(DateTime('2020-09-21T20:01:37Z'));

requestBody.setAvailabilityEndDateTime(DateTime('2021-12-31T20:01:37Z'));

requestBody.setLanguageTags(['en-us', ]);

requestBody.setPlatforms([requestBody.setDevicePlatformType(DevicePlatformType('ios'));
]);
...
result = await client.search().qnas().post(requestBody);
