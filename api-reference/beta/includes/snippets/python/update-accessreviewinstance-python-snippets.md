...
result = await client.identityGovernance.accessReviews.definitionsby_id('accessReviewScheduleDefinition-id').instancesby_id('accessReviewInstance-id').patch(request_body)
