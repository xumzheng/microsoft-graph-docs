...
result = await client.identityGovernance.lifecycleWorkflows.workflowsby_id('workflow-id').userProcessingResultsby_id('userProcessingResult-id').taskProcessingResults.get(request_config)
