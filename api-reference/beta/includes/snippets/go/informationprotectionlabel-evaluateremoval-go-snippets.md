...
keyValuePair.SetOdataType(&odataType) 
...
odataType := "#microsoft.graph.keyValuePair"
keyValuePair1.SetOdataType(&odataType) 
...
odataType := "#microsoft.graph.keyValuePair"
keyValuePair2.SetOdataType(&odataType) 
...
odataType := "#microsoft.graph.keyValuePair"
keyValuePair3.SetOdataType(&odataType) 
...
odataType := "#microsoft.graph.keyValuePair"
keyValuePair4.SetOdataType(&odataType) 
...
odataType := "#microsoft.graph.keyValuePair"
keyValuePair5.SetOdataType(&odataType) 
...
odataType := "#microsoft.graph.keyValuePair"
keyValuePair6.SetOdataType(&odataType) 
...
result, err := graphClient.InformationProtection().Policy().Labels().EvaluateRemoval().PostWithRequestConfigurationAndResponseHandler(requestBody, configuration, nil)
