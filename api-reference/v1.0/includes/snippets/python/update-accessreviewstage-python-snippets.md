...
request_body = Access_review_stage()
request_body.@odata_type = '#microsoft.graph.accessReviewStage'

reviewers_access_review_reviewer_scope1 = Access_review_reviewer_scope()
...
fallback_reviewers_access_review_reviewer_scope1 = Access_review_reviewer_scope()
...
fallback_reviewers_access_review_reviewer_scope2 = Access_review_reviewer_scope()
