...
result = await client.identityGovernance.lifecycleWorkflows.workflows._by_id('workflow-id').runs._by_id('run-id').userProcessingResults._by_id('userProcessingResult-id').taskProcessingResults.get(request_config)
