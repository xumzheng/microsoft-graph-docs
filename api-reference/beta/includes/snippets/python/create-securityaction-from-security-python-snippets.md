...
request_config = SecurityActionsRequestBuilderPostRequestConfiguration(
request_config = SecurityActionsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.security.securityActions.post(request_body, headers=)
