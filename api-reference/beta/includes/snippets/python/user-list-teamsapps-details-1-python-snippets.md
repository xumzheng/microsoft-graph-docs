...
requestConfiguration = UserScopeTeamsAppInstallationRequestBuilderGetRequestConfiguration();

queryParameters = UserScopeTeamsAppInstallationRequestBuilderGetQueryParameters();
