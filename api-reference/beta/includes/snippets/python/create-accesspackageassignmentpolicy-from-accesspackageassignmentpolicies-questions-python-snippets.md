...
request_body.setAccessPackageId('b2eba9a1-b357-42ee-83a8-336522ed6cbf')
...
request_config = AccessPackageAssignmentPoliciesRequestBuilderPostRequestConfiguration(
request_config = AccessPackageAssignmentPoliciesRequestBuilderPostRequestConfiguration(query_params=)
