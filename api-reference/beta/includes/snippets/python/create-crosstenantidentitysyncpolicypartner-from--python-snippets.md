...
await client.policies.crossTenantAccessPolicy.partnersby_id('crossTenantAccessPolicyConfigurationPartner-tenantId').identitySynchronization.put(request_body)
