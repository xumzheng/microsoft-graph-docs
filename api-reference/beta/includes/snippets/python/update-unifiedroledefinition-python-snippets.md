...
request_body = Unified_role_definition()
...
role_permissions_unified_role_permission1 = Unified_role_permission()
...
result = await client.role_management.directory.role_definitions.by_role_definition_id('unifiedRoleDefinition-id').patch(request_body = request_body)
