...
request_config = AlertRulesRequestBuilderPostRequestConfiguration(
request_config = AlertRulesRequestBuilderPostRequestConfiguration(query_params=)


result = await client.deviceManagement.monitoring.alertRules.post(request_body, headers=)
