...
request_config = CertificateBasedAuthConfigurationRequestBuilderPostRequestConfiguration(
request_config = CertificateBasedAuthConfigurationRequestBuilderPostRequestConfiguration(query_params=)


await client.organization_by_id('organization-id').certificateBasedAuthConfiguration.post(request_body, headers=)
