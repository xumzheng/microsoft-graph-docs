...
request_config = PositionsRequestBuilderPostRequestConfiguration(
request_config = PositionsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.me.profile.positions.post(request_body, headers=)
