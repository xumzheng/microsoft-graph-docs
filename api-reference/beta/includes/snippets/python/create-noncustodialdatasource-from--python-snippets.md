...
await client.compliance.ediscovery.casesById('case-id').sourceCollectionsById('sourceCollection-id').noncustodialSourcesById('noncustodialDataSource-id').post(request_body)
