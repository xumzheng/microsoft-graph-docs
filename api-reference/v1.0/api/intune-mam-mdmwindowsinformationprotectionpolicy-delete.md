...
<!-- { "blockType": "permissions", "name": "intune_mam_mdmwindowsinformationprotectionpolicy_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-mdmwindowsinformationprotectionpolicy-delete-permissions.md)]
