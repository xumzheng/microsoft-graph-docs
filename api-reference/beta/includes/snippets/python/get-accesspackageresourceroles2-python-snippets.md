...
request_config = AccessPackageResourceRolesRequestBuilderGetRequestConfiguration(query_params=params['filter'] = "(originSystem eq 'SharePointOnline' and accessPackageResource/id eq '53c71803-a0a8-4777-aecc-075de8ee3991')"
params['select'] = ["displayName","originId"]
)
