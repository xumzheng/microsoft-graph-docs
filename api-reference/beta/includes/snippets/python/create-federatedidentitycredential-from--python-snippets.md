...
request_configuration = FederatedIdentityCredentialsRequestBuilderPostRequestConfiguration(
)


result = await client.applications_by_id('application-id').federatedIdentityCredentials.post(request_body = request_body)
