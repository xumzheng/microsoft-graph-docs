...
messageHistoryChatMessageHistoryItem1.setModifiedDateTime(DateTime('2018-10-21T08:10:30.489Z'))

messageHistoryChatMessageHistoryItem1.setActions(ChatMessageActions('reactionadded'))
...
messageHistoryChatMessageHistoryItem2.setModifiedDateTime(DateTime('2018-10-21T08:10:32.489Z'))

messageHistoryChatMessageHistoryItem2.setActions(ChatMessageActions('reactionadded'))
...
messageHistoryChatMessageHistoryItem3.setModifiedDateTime(DateTime('2018-10-21T02:17:14.67Z'))

messageHistoryChatMessageHistoryItem3.setActions(ChatMessageActions('reactionadded'))
...
messageHistoryChatMessageHistoryItem4.setModifiedDateTime(DateTime('2018-10-21T02:34:40.3Z'))

messageHistoryChatMessageHistoryItem4.setActions(ChatMessageActions('reactionadded'))
...
messageHistoryChatMessageHistoryItem5.setModifiedDateTime(DateTime('2018-10-21T08:10:25.489Z'))

messageHistoryChatMessageHistoryItem5.setActions(ChatMessageActions('reactionadded'))
...
messageHistoryChatMessageHistoryItem6.setModifiedDateTime(DateTime('2018-10-21T08:10:31.489Z'))

messageHistoryChatMessageHistoryItem6.setActions(ChatMessageActions('reactionadded'))
...
messageHistoryChatMessageHistoryItem7.setModifiedDateTime(DateTime('2018-10-21T08:10:33.489Z'))

messageHistoryChatMessageHistoryItem7.setActions(ChatMessageActions('reactionadded'))
...
messageHistoryChatMessageHistoryItem8.setModifiedDateTime(DateTime('2018-10-21T08:10:34.489Z'))

messageHistoryChatMessageHistoryItem8.setActions(ChatMessageActions('surprised'))
...
request_body.setMessageHistory(messageHistoryArray)




result = await client.teams_by_id('team-id').channels_by_id('channel-id').messages_by_id('chatMessage-id').patch(request_body)
