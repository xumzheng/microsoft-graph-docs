...
request_config = PartnersRequestBuilderPostRequestConfiguration(
request_config = PartnersRequestBuilderPostRequestConfiguration(query_params=)


result = await client.policies.crossTenantAccessPolicy.partners.post(request_body, headers=)
