...
request_config = ProfileCardPropertiesRequestBuilderPostRequestConfiguration(
request_config = ProfileCardPropertiesRequestBuilderPostRequestConfiguration(query_params=)


result = await client.organization_by_id('organization-id').settings.profileCardProperties.post(request_body, headers=)
