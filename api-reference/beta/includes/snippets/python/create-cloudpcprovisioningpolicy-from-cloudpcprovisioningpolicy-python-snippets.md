...
request_config = ProvisioningPoliciesRequestBuilderPostRequestConfiguration(
request_config = ProvisioningPoliciesRequestBuilderPostRequestConfiguration(query_params=)


result = await client.deviceManagement.virtualEndpoint.provisioningPolicies.post(request_body, headers=)
