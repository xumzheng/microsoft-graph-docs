...
request_config = CopyToDefaultContentLocationRequestBuilderPostRequestConfiguration(
request_config = CopyToDefaultContentLocationRequestBuilderPostRequestConfiguration(query_params=)


await client.sites_by_id('site-id').contentTypes_by_id('contentType-id').copyToDefaultContentLocation.post(request_body, headers=)
