...
request_config = EvaluateClassificationResultsRequestBuilderPostRequestConfiguration(query_params=)
headers['User-Agent'] = "ContosoLOBApp/1.0"


result = await client.informationProtection.policy.labels.evaluateClassificationResults.post(request_body, request_config, headers=request_config)
