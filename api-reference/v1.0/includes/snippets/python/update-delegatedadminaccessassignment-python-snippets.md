...
result = await client.tenantRelationships.delegatedAdminRelationships._by_id('delegatedAdminRelationship-id').accessAssignments._by_id('delegatedAdminAccessAssignment-id').patch(request_body, request_config)
