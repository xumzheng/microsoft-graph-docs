...
request_config = SourceSystemsRequestBuilderPostRequestConfiguration(
request_config = SourceSystemsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.external.industryData.sourceSystems.post(request_body, headers=)
