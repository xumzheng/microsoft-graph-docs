...
request_config = ShiftRequestBuilderPutRequestConfiguration(query_params=)
System.Collections.Generic.List`1[System.Tuple`2[System.String,System.String]])


await client.teams_by_id('team-id').schedule.shifts_by_id('shift-id').put(request_body, request_config, headers=request_config)
