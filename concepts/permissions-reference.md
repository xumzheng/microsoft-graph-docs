...
|_Device.Delete.All_ |Delete a device |Allows the app to delete a device on behalf of a signed-in user. |Yes | Yes |
|_Device.ReadWrite.All_ |Read and write all device properties |Allows the app to read and write all properties of a device on behalf of a signed-in user. |Yes | Yes |
|_Device.EnableDisableAccount.All_ |Enable or disable a device account |Allows the app to enable or disable a device account on behalf of a signed-in user. |Yes | Yes |
|_Device.DisableAccount_ |Disable user's device accounts |Allows the app to disable the signed-in user's device account their behalf. |Yes | Yes |
