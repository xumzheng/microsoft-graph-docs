...
await client.security.cases.ediscoveryCases._by_id('ediscoveryCase-id').reviewSets._by_id('ediscoveryReviewSet-id').securityaddToReviewSet.post(request_body)
