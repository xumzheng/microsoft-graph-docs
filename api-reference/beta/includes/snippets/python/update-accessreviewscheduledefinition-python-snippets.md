...
request_config = AccessReviewScheduleDefinitionRequestBuilderPutRequestConfiguration(
request_config = AccessReviewScheduleDefinitionRequestBuilderPutRequestConfiguration(query_params=)


await client.identityGovernance.accessReviews.definitions_by_id('accessReviewScheduleDefinition-id').put(request_body, headers=)
