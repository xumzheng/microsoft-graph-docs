...
request_config = RecordResponseRequestBuilderPostRequestConfiguration(
request_config = RecordResponseRequestBuilderPostRequestConfiguration(query_params=)


result = await client.communications.calls_by_id('call-id').recordResponse.post(request_body, headers=)
