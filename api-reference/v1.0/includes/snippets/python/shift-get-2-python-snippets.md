...
request_config = ShiftPreferencesRequestBuilderPatchRequestConfiguration(
request_config = ShiftPreferencesRequestBuilderPatchRequestConfiguration(query_params=)


result = await client.users_by_id('user-id').settings.shiftPreferences.patch(request_body, headers=)
