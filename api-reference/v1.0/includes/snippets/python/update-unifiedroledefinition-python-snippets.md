...
request_config = UnifiedRoleDefinitionRequestBuilderPatchRequestConfiguration(
request_config = UnifiedRoleDefinitionRequestBuilderPatchRequestConfiguration(query_params=)


result = await client.roleManagement.directory.roleDefinitions_by_id('unifiedRoleDefinition-id').patch(request_body, headers=)
