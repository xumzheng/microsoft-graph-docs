...
request_config = SetStatusMessageRequestBuilderPostRequestConfiguration(
request_config = SetStatusMessageRequestBuilderPostRequestConfiguration(query_params=)


await client.users_by_id('user-id').presence.setStatusMessage.post(request_body, headers=)
