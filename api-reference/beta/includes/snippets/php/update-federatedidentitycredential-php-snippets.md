...
$requestRequestBody->setAudiences(['api://AzureADTokenExchange',]);
$result =  $graphClient->applicationsById('application-id')->federatedIdentityCredentialsById('federatedIdentityCredential-id')->patch($requestRequestBody);
