...
request_config = InviteRequestBuilderPostRequestConfiguration(
request_config = InviteRequestBuilderPostRequestConfiguration(query_params=)


result = await client.communications.calls_by_id('call-id').participants.invite.post(request_body, headers=)
