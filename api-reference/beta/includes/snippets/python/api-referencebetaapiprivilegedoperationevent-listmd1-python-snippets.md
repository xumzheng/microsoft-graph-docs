...
request_config = PrivilegedOperationEventsRequestBuilderGetRequestConfiguration(query_params=query_params = PrivilegedOperationEventsRequestBuilderGetQueryParameters()
