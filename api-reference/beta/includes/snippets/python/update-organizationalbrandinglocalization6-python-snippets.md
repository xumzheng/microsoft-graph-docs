...
request_config = OrganizationalBrandingLocalizationRequestBuilderPatchRequestConfiguration(
request_config = OrganizationalBrandingLocalizationRequestBuilderPatchRequestConfiguration(query_params=)
