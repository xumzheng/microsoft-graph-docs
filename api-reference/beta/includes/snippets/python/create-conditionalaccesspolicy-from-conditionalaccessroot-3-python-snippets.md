...
conditionsplatforms = Conditional_access_platforms()
...
conditionsdevice_states = Conditional_access_device_states()
...
session_controls = Conditional_access_session_controls()
session_controls.applicationEnforcedRestrictions=null

session_controls.persistentBrowser=null

session_controlscloud_app_security = Cloud_app_security_session_control()
...
session_controlssign_in_frequency = Sign_in_frequency_session_control()
