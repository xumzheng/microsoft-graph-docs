...
$activitiesactivities1->setStartDateTime(new DateTime("2019-03-11T15:00:00Z"));
$activitiesactivities1->setEndDateTime(new DateTime("2019-03-11T15:15:00Z"));
...
$activitiesactivities1->setIsPaid(True);
$activitiesactivities1->setStartDateTime(new DateTime("2019-03-11T15:00:00Z"));
$activitiesactivities1->setEndDateTime(new DateTime("2019-03-11T15:30:00Z"));
$activitiesactivities1->setCode('');
$activitiesactivities1->setDisplayName('Lunch');
