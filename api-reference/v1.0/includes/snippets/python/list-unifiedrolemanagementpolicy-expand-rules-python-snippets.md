...
request_config = RoleManagementPoliciesRequestBuilderGetRequestConfiguration(query_params=query_params = RoleManagementPoliciesRequestBuilderGetQueryParameters()
