...
request_configuration = TimesOffRequestBuilderGetRequestConfiguration(query_params=query_params = TimesOffRequestBuilderGetQueryParameters()
...
result = await client.teams_by_id('team-id').schedule.timesOff.get(request_configuration)
