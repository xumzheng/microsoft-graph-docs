...
request_body = Planner_plan_configuration()
request_body.@odata_type = '#microsoft.graph.plannerPlanConfiguration'

request_body.default_language = 'en-us'

buckets_planner_plan_configuration_bucket_definition1 = Planner_plan_configuration_bucket_definition()
...
buckets_planner_plan_configuration_bucket_definition2 = Planner_plan_configuration_bucket_definition()
...
buckets_planner_plan_configuration_bucket_definition3 = Planner_plan_configuration_bucket_definition()
...
buckets_planner_plan_configuration_bucket_definition4 = Planner_plan_configuration_bucket_definition()
