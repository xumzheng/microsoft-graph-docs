...
request_config = RegistrationRequestBuilderPatchRequestConfiguration(
request_config = RegistrationRequestBuilderPatchRequestConfiguration(query_params=)


result = await client.me.onlineMeetings_by_id('onlineMeeting-id').registration.patch(request_body, headers=)
