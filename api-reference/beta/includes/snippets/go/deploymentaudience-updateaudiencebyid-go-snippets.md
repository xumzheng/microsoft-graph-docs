...
graphClient.Admin().Windows().Updates().DeploymentsById("deployment-id").Audience().MicrosoftGraphWindowsUpdatesUpdateAudienceById().Post(context.Background(), requestBody, nil)
