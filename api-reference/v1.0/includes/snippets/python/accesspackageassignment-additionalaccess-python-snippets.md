...
result = await client.identityGovernance.entitlementManagement.assignments_by_id('accessPackageAssignment-id').get(request_configuration = request_configuration)
