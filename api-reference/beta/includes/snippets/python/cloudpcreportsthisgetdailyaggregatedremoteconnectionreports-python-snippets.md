...
request_config = GetDailyAggregatedRemoteConnectionReportsRequestBuilderPostRequestConfiguration(
request_config = GetDailyAggregatedRemoteConnectionReportsRequestBuilderPostRequestConfiguration(query_params=)
