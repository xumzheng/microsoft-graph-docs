...
result = await client.identity.b2xUserFlows._by_id('b2xIdentityUserFlow-id').userAttributeAssignments._by_id('identityUserFlowAttributeAssignment-id').get(request_config)
