...
result, err := graphClient.ServicePrincipalsById("servicePrincipal-id").Synchronization().JobsById("synchronizationJob-id").MicrosoftGraphProvisionOnDemand().Post(context.Background(), requestBody, nil)
