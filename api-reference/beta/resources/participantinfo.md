...
| nonAnonymizedIdentity | [identitySet](identityset.md)   | The non anonymized [identitySet](identityset.md) associated with this participant. Read-only.                                                                                   |
...
```json
{
  ...
  "languageId": "String",
  "nonAnonymizedIdentity": { "@odata.type": "#microsoft.graph.identitySet" },
  "region": "String",
  "platformId": "String",
