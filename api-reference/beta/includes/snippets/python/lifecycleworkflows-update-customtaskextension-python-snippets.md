...
request_config = CustomTaskExtensionRequestBuilderPatchRequestConfiguration(
request_config = CustomTaskExtensionRequestBuilderPatchRequestConfiguration(query_params=)


result = await client.identityGovernance.lifecycleWorkflows.customTaskExtensions_by_id('customTaskExtension-id').patch(request_body, headers=)
