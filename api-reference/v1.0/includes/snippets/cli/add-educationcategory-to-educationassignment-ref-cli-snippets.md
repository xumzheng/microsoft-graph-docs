...
mgc education classes item assignments item categories ref post --education-class-id {educationClass-id} --education-assignment-id {educationAssignment-id} --body '{
