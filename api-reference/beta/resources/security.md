...
| threatSubmission | [microsoft.graph.security.threatSubmissionRoot](../resources/security-threatsubmissionroot.md) | Provides tenants capability to submit threat to Microsoft; for example, a suspicious email threat, URL threat, or file threat.|
