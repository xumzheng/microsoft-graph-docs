...
result = await client.identityGovernance.lifecycleWorkflows.workflows_by_id('workflow-id').userProcessingResults_by_id('userProcessingResult-id').taskProcessingResults.get(request_configuration = request_configuration)
