...
request_config = EmailThreatsRequestBuilderPostRequestConfiguration(
request_config = EmailThreatsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.security.threatSubmission.emailThreats.post(request_body, headers=)
