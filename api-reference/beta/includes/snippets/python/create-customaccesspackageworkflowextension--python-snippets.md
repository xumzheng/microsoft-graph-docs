...
request_config = CustomAccessPackageWorkflowExtensionsRequestBuilderPostRequestConfiguration(
request_config = CustomAccessPackageWorkflowExtensionsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.identityGovernance.entitlementManagement.accessPackageCatalogs_by_id('accessPackageCatalog-id').customAccessPackageWorkflowExtensions.post(request_body, headers=)
