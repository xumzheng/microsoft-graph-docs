...
recipientsDriveRecipient1.email = 'robin@contoso.org'
...
request_body.expirationDateTime = '2018-07-15T14:00:00.000Z'




result = await client.drives_by_id('drive-id').items_by_id('driveItem-id').invite.post(request_body = request_body)
