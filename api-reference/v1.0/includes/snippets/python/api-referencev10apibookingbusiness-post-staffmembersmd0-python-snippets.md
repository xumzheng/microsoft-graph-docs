...
request_config = StaffMembersRequestBuilderPostRequestConfiguration(
request_config = StaffMembersRequestBuilderPostRequestConfiguration(query_params=)


result = await client.solutions.bookingBusinesses_by_id('bookingBusiness-id').staffMembers.post(request_body, headers=)
