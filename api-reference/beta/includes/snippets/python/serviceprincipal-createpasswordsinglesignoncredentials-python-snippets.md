...
request_config = CreatePasswordSingleSignOnCredentialsRequestBuilderPostRequestConfiguration(
request_config = CreatePasswordSingleSignOnCredentialsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.servicePrincipals_by_id('servicePrincipal-id').createPasswordSingleSignOnCredentials.post(request_body, headers=)
