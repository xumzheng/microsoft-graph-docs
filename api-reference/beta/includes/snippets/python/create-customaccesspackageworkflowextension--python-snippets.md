...
result = await client.identityGovernance.entitlementManagement.accessPackageCatalogs_by_id('accessPackageCatalog-id').customAccessPackageWorkflowExtensions.post(request_body)
