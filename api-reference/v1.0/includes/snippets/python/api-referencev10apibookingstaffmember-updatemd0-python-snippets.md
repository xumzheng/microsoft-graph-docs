...
request_config = BookingStaffMemberBaseRequestBuilderPatchRequestConfiguration(
request_config = BookingStaffMemberBaseRequestBuilderPatchRequestConfiguration(query_params=)


result = await client.solutions.bookingBusinesses_by_id('bookingBusiness-id').staffMembers_by_id('bookingStaffMemberBase-id').patch(request_body, headers=)
