...
request_config = ServicesRequestBuilderPostRequestConfiguration(
request_config = ServicesRequestBuilderPostRequestConfiguration(query_params=)


result = await client.solutions.bookingBusinesses_by_id('bookingBusiness-id').services.post(request_body, headers=)
