...
breaks_time_card_break1 = Time_card_break()
breaks_time_card_break1.break_id = 'string'

breaks_time_card_break1notes = Item_body()
...
breaks_time_card_break1start = Time_card_event()
...
breaks_time_card_break1startnotes = Item_body()
