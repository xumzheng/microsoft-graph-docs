...
request_configuration = LearningProviderRequestBuilderPatchRequestConfiguration(
)


result = await client.employeeExperience.learningProviders_by_id('learningProvider-id').patch(request_body = request_body)
