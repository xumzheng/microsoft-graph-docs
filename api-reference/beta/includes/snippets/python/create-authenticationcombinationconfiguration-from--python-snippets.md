...
result = await client.identity.conditionalAccess.authenticationStrengths.policies_by_id('authenticationStrengthPolicy-id').combinationConfigurations.post(request_body)
