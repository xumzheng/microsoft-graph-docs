...
request_config = IdentitySynchronizationRequestBuilderPutRequestConfiguration(
request_config = IdentitySynchronizationRequestBuilderPutRequestConfiguration(query_params=)
