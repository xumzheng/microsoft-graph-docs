...
request_config = ComplianceChangesRequestBuilderPostRequestConfiguration(
request_config = ComplianceChangesRequestBuilderPostRequestConfiguration(query_params=)


result = await client.admin.windows.updates.updatePolicies_by_id('updatePolicy-id').complianceChanges.post(request_body, headers=)
