...
requestBody.setRequestType(AccessPackageRequestType('adminupdate'));
...
result = awaitclient.identityGovernance().entitlementManagement().assignmentRequests().post(requestBody);
