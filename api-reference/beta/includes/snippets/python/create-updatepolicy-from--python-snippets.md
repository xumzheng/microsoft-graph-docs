...
request_body.setAudience($audience)
...
request_body.setComplianceChanges(complianceChangesArray)
...
request_body.setComplianceChangeRules(complianceChangeRulesArray)
...
request_config = UpdatePoliciesRequestBuilderPostRequestConfiguration(
request_config = UpdatePoliciesRequestBuilderPostRequestConfiguration(query_params=)


result = await client.admin.windows.updates.updatePolicies.post(request_body, headers=)
