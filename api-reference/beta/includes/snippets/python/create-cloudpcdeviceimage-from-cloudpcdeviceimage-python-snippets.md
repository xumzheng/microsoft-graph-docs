...
request_config = DeviceImagesRequestBuilderPostRequestConfiguration(
request_config = DeviceImagesRequestBuilderPostRequestConfiguration(query_params=)


result = await client.deviceManagement.virtualEndpoint.deviceImages.post(request_body, headers=)
