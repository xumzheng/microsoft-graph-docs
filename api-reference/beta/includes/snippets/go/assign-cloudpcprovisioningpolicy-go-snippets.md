...
graphClient.DeviceManagement().VirtualEndpoint().ProvisioningPoliciesById("cloudPcProvisioningPolicy-id").MicrosoftGraphAssign().Post(context.Background(), requestBody, nil)
