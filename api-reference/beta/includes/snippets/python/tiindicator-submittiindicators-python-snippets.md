...
// THE PYTHON SDK IS IN PREVIEW. NON-PRODUCTION USE ONLY$requestBody = new SubmitTiIndicatorsPostRequestBody();
...
$requestResult = $graphServiceClient.security().tiIndicators().submitTiIndicators().post($requestBody);
