...
result = await client.roleManagement.deviceManagement.roleAssignments_by_id('unifiedRoleAssignmentMultiple-id').get(request_configuration = request_configuration)
