...
request_config = UpdateTiIndicatorsRequestBuilderPostRequestConfiguration(
request_config = UpdateTiIndicatorsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.security.tiIndicators.updateTiIndicators.post(request_body, headers=)
