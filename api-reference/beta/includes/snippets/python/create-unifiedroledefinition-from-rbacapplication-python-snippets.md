...
request_config = RoleDefinitionsRequestBuilderPostRequestConfiguration(
request_config = RoleDefinitionsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.roleManagement.directory.roleDefinitions.post(request_body, headers=)
