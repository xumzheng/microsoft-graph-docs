...
result = await client.identityGovernance_entitlementManagement_accessPackageCatalogsby_id('accessPackageCatalog-id')_accessPackageCustomWorkflowExtensions.post(request_body)
