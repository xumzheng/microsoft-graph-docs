...
request_config = ContinuousAccessEvaluationPolicyRequestBuilderPatchRequestConfiguration(
request_config = ContinuousAccessEvaluationPolicyRequestBuilderPatchRequestConfiguration(query_params=)
