...
result = await client.identityGovernance.lifecycleWorkflows.workflowsById('workflow-id').taskReportsById('taskReport-id').taskProcessingResults.get(request_config)
