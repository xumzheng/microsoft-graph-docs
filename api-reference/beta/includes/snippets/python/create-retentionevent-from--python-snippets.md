...
request_config = RetentionEventsRequestBuilderPostRequestConfiguration(
request_config = RetentionEventsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.security.triggers.retentionEvents.post(request_body, headers=)
