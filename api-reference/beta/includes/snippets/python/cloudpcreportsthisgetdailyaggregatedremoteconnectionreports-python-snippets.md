...
request_configuration = GetDailyAggregatedRemoteConnectionReportsRequestBuilderPostRequestConfiguration(
)


await client.deviceManagement.virtualEndpoint.reports.getDailyAggregatedRemoteConnectionReports.post(request_body = request_body)
