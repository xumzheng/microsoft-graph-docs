...
requestBody = FederatedIdentityCredential();
...
result = await client.applicationsById('application-id').federatedIdentityCredentialsById('federatedIdentityCredential-id').patch(requestBody);
