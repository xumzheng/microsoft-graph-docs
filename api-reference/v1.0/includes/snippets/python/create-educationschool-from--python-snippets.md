...
request_config = SchoolsRequestBuilderPostRequestConfiguration(
request_config = SchoolsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.education.schools.post(request_body, headers=)
