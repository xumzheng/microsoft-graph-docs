...
request_configuration = SetPresenceRequestBuilderPostRequestConfiguration(
)


await client.users_by_id('user-id').presence.setPresence.post(request_body = request_body)
