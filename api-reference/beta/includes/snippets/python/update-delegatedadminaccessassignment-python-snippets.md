...
result = await client.tenantRelationships.delegatedAdminRelationshipsById('delegatedAdminRelationship-id').accessAssignmentsById('delegatedAdminAccessAssignment-id').patch(request_body, request_config)
