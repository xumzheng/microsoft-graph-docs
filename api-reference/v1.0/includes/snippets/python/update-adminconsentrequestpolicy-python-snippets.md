...
request_config = AdminConsentRequestPolicyRequestBuilderPutRequestConfiguration(
request_config = AdminConsentRequestPolicyRequestBuilderPutRequestConfiguration(query_params=)


await client.policies.adminConsentRequestPolicy.put(request_body, headers=)
