...
request_body = Learning_provider()
...
result = await client.employee_experience.learning_providers.by_learning_provider_id('learningProvider-id').patch(request_body = request_body)
