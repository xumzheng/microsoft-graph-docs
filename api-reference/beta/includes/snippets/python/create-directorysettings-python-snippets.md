...
request_config = SettingsRequestBuilderPostRequestConfiguration(
request_config = SettingsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.settings.post(request_body, headers=)
