...
default_locationaddress = Physical_address()
...
default_reminders_booking_reminder1 = Booking_reminder()
...
scheduling_policy = Booking_scheduling_policy()
...
result = await client.booking_businesses.by_booking_businesse_id('bookingBusiness-id').services.post(request_body = request_body)
