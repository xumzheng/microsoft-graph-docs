...
request_config = BookingBusinessesRequestBuilderPostRequestConfiguration(
request_config = BookingBusinessesRequestBuilderPostRequestConfiguration(query_params=)


result = await client.solutions.bookingBusinesses.post(request_body, headers=)
