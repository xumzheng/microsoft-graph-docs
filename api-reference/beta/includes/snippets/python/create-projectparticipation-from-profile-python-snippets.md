...
request_config = ProjectsRequestBuilderPostRequestConfiguration(
request_config = ProjectsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.me.profile.projects.post(request_body, headers=)
