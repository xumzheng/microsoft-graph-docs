...
request_body.setDisplayName('Contoso admin relationship')

$request_body.setDuration( \DateInterval('P730D'))
...
request_config = DelegatedAdminRelationshipsRequestBuilderPostRequestConfiguration(
request_config = DelegatedAdminRelationshipsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.tenantRelationships.delegatedAdminRelationships.post(request_body, headers=)
