...
$assignmentsassignments1 = new CloudPcProvisioningPolicyAssignment();
...
$result =  $graphClient->deviceManagement()->virtualEndpoint()->provisioningPoliciesById('cloudPcProvisioningPolicy-id')->assign()->post($requestRequestBody);
