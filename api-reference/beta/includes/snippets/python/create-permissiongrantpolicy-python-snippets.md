...
request_config = PermissionGrantPoliciesRequestBuilderPostRequestConfiguration(
request_config = PermissionGrantPoliciesRequestBuilderPostRequestConfiguration(query_params=)


result = await client.policies.permissionGrantPolicies.post(request_body, headers=)
