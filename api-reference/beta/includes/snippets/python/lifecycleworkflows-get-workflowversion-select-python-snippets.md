...
result = await client.identityGovernance.lifecycleWorkflows.workflows._by_id('workflow-id').versions._by_id('workflowVersion-versionNumber').get(request_config)
