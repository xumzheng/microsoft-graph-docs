...
awaitclient.security().cases().ediscoveryCasesById('ediscoveryCase-id').searchesById('ediscoverySearch-id').noncustodialSourcesById('ediscoveryNoncustodialDataSource-id').post(requestBody);
