...
$clientAppTypesArray = [];
'all',$clientAppTypesArray []= $clientAppTypesclientAppTypes1;
...
$locations->setIncludeLocations(['198ad66e-87b3-4157-85a3-8a7b51794ee9',]);
...
'block',$builtInControlsArray []= $builtInControlsbuiltInControls1;
