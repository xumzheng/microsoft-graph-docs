...
request_body = Assign_post_request_body()
assignments_cloud_pc_provisioning_policy_assignment1 = Cloud_pc_provisioning_policy_assignment()
...
assignments_cloud_pc_provisioning_policy_assignment1target = Cloud_pc_management_assignment_target()
...
assignments_cloud_pc_provisioning_policy_assignment1target.additional_data(additional_data)
...
additional_data = [
'@odata_type' => '#microsoft.graph.cloudPcProvisioningPolicyAssignment', 
];
