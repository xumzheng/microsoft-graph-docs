...
request_config = MicrosoftApplicationDataAccessRequestBuilderPatchRequestConfiguration(
request_config = MicrosoftApplicationDataAccessRequestBuilderPatchRequestConfiguration(query_params=)
