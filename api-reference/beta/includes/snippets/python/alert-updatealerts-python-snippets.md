...
request_config = UpdateAlertsRequestBuilderPostRequestConfiguration(
request_config = UpdateAlertsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.security.alerts.updateAlerts.post(request_body, headers=)
