...
request_config = CombinationConfigurationsRequestBuilderPostRequestConfiguration(
request_config = CombinationConfigurationsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.identity.conditionalAccess.authenticationStrengths.policies_by_id('authenticationStrengthPolicy-id').combinationConfigurations.post(request_body, headers=)
