...
request_body = Qna()
request_body.displayName = 'Global Country Holidays'
...
request_body.Platforms([request_body.DevicePlatformType(DevicePlatformType('ios'))
])
...
request_configuration = QnasRequestBuilderPostRequestConfiguration(
)
