...
request_config = AssignmentPoliciesRequestBuilderPostRequestConfiguration(
request_config = AssignmentPoliciesRequestBuilderPostRequestConfiguration(query_params=)
