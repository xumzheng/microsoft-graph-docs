...
additionalData = [
'certificateUserBindings' => certificate_user_bindings1 = ()
...
request_body.authentication_mode_configuration = authenticationModeConfiguration

'includeTargets' => include_targets1 = ()
includeTargets1.targetType = 'group'

includeTargets1.id = 'all_users'

includeTargets1.is_registration_required = False
