...
request_configuration = CheckMemberObjectsRequestBuilderPostRequestConfiguration(
)


result = await client.me.checkMemberObjects.post(request_body = request_body)
