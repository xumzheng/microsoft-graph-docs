...
<!-- { "blockType": "permissions", "name": "intune_mam_iosmanagedappprotection_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-iosmanagedappprotection-update-permissions.md)]
