...
$requestBody.setDuration( \DateInterval('P31D'));
...
result = await client.tenantRelationships().delegatedAdminRelationshipsById('delegatedAdminRelationship-id').patch(requestBody, request_config);
