...
request_config = CustomSecurityAttributeDefinitionsRequestBuilderPostRequestConfiguration(
request_config = CustomSecurityAttributeDefinitionsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.directory.customSecurityAttributeDefinitions.post(request_body, headers=)
