...
request_configuration = UnhideForUserRequestBuilderPostRequestConfiguration(
)


await client.chats_by_id('chat-id').unhideForUser.post(request_body = request_body)
