...
<!-- { "blockType": "permissions", "name": "intune_mam_mdmwindowsinformationprotectionpolicy_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-mdmwindowsinformationprotectionpolicy-update-permissions.md)]
