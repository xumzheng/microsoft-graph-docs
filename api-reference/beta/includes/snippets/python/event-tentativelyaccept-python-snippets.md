...
request_body = Tentatively_accept_post_request_body()
request_body.comment = 'I may not be able to make this week. How about next week?'

request_body.send_response = True

proposed_new_time = Time_slot()
proposed_new_timestart = Date_time_time_zone()
...
proposed_new_timeend = Date_time_time_zone()
