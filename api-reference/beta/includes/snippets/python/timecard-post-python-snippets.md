...
request_config = TimeCardsRequestBuilderPostRequestConfiguration(
request_config = TimeCardsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.teams_by_id('team-id').schedule.timeCards.post(request_body, headers=)
