...
requestBody.setInvoiceStatus(BookingInvoiceStatus('open'));
...
requestBody.setPriceType(BookingPriceType('fixedprice'));
...
result = await client.bookingBusinessesById('bookingBusiness-id').appointments().post(requestBody);
