...
request_config = TeamsRequestBuilderGetRequestConfiguration(query_params=query_params = TeamsRequestBuilderGetQueryParameters()
...
await client.teams.get(request_config, headers=request_config)
