...
request_config = PersonCertificationRequestBuilderPatchRequestConfiguration(
request_config = PersonCertificationRequestBuilderPatchRequestConfiguration(query_params=)
