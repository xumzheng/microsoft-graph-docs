...
await client.security.cases.ediscoveryCases._by_id('ediscoveryCase-id').searches._by_id('ediscoverySearch-id').noncustodialSources._by_id('ediscoveryNoncustodialDataSource-id').post(request_body)
