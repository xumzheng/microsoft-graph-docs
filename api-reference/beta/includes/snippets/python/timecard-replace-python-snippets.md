...
request_config = TimeCardRequestBuilderPutRequestConfiguration(
request_config = TimeCardRequestBuilderPutRequestConfiguration(query_params=)


await client.teams_by_id('team-id').schedule.timeCards_by_id('timeCard-id').put(request_body, headers=)
