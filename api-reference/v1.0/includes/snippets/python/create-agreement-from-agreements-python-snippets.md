...
request_config = AgreementsRequestBuilderPostRequestConfiguration(
request_config = AgreementsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.identityGovernance.termsOfUse.agreements.post(request_body, headers=)
