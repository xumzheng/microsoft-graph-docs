...
request_body = Access_package_assignment_policy()
...
request_approval_settings = Access_package_assignment_approval_settings()
...
stages_access_package_approval_stage1 = Access_package_approval_stage()
...
primary_approvers_subject_set1 = Subject_set()
...
fallback_primary_approvers_subject_set1 = Subject_set()
...
fallback_primary_approvers_subject_set2 = Subject_set()
...
stages_access_package_approval_stage2 = Access_package_approval_stage()
...
review_settings = Access_package_assignment_review_settings()
...
review_settingsschedule = Entitlement_management_schedule()
review_settingsschedule.startDateTime = DateTime('2022-07-02T06:59:59.998Z')

review_settingsscheduleexpiration = Expiration_pattern()
...
review_settingsschedulerecurrence = Patterned_recurrence()
review_settingsschedulerecurrencepattern = Recurrence_pattern()
...
review_settingsschedulerecurrencerange = Recurrence_range()
...
primary_reviewers_subject_set1 = Subject_set()
