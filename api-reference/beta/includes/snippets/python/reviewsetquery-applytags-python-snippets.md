...
await client.compliance.ediscovery.cases_by_id('case-id').reviewSets_by_id('reviewSet-id').queries_by_id('reviewSetQuery-id').ediscoveryapplyTags.post(request_body)
