...
request_configuration = BulkSetCloudPcReviewStatusRequestBuilderPostRequestConfiguration(
)


result = await client.deviceManagement.managedDevices.bulkSetCloudPcReviewStatus.post(request_body = request_body)
