...
$membersmembers3 = new ConversationMember();

$membersmembers3->setRoles(['guest',]);
$membersmembers3AdditionalData = [
"@odata.type" => '#microsoft.graph.aadUserConversationMember',
"user@odata.bind" => 'https://graph.microsoft.com/beta/users(\'8ba98gf6-7fc2-4eb2-c7f2-aef9f21fd98g\')',
];
$membersmembers3->setAdditionalData($membersmembers3AdditionalData);

$membersArray []= $membersmembers3;
