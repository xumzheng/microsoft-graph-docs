...
graphClient.Admin().Windows().Updates().UpdatableAssetsById("updatableAsset-id").MicrosoftGraphWindowsUpdatesRemoveMembers().Post(context.Background(), requestBody, nil)
