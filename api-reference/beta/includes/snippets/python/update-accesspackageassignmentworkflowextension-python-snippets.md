...
request_config = CustomCalloutExtensionRequestBuilderPutRequestConfiguration(
request_config = CustomCalloutExtensionRequestBuilderPutRequestConfiguration(query_params=)
