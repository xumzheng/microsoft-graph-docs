...
await client.compliance.ediscovery.cases_by_id('case-id').sourceCollections_by_id('sourceCollection-id').noncustodialSources_by_id('noncustodialDataSource-id').post(request_body)
