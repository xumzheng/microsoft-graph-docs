...
| Teams [CallTranscript](/graph/api/resources/calltranscript) | Any transcript becomes available in the tenant. Any transcript becomes available for a specific meeting.| No |
| Teams [CallRecording](/graph/api/resources/callrecording) | Any recording becomes available in the tenant. Any recording becomes available for a specific meeting. | Yes |
