...
$requestRequestBody->setRoles(['write',]);
$grantedToIdentitiesArray = [];

$grantedToIdentitiesgrantedToIdentities1 = new IdentitySet();


$application = new Identity();
$grantedToIdentitiesgrantedToIdentities1->setApplication($application);
...
$grantedToIdentitiesArray []= $grantedToIdentitiesgrantedToIdentities1;
