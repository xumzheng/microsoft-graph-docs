...
result = await client.policies_crossTenantAccessPolicy_partnersby_id('crossTenantAccessPolicyConfigurationPartner-tenantId')_identitySynchronization.patch(request_body)
