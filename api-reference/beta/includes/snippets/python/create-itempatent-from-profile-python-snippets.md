...
request_body.displayName = 'Inferring User Intent through browsing behaviors'

request_body.isPending = true
...
request_configuration = PatentsRequestBuilderPostRequestConfiguration(
)
