...
request_config = MeetingAttendanceReportRequestBuilderGetRequestConfiguration(query_params=query_params = MeetingAttendanceReportRequestBuilderGetQueryParameters()
