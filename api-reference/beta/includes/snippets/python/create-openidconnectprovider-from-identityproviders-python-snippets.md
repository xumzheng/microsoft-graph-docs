...
request_config = IdentityProvidersRequestBuilderPostRequestConfiguration(
request_config = IdentityProvidersRequestBuilderPostRequestConfiguration(query_params=)


result = await client.identityProviders.post(request_body, headers=)
