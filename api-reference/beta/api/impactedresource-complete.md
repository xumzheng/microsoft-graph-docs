...
-->
``` http
POST /directory/impactedResources/{impactedResourceId}/complete
POST /recommendationBase/impactedResources/{impactedResourceId}/complete
```
...
-->
``` http
POST https://graph.microsoft.com/beta/directory/impactedResources/{impactedResourceId}/complete
```
