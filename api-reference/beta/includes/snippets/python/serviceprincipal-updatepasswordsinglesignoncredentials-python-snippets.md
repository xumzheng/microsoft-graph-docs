...
request_body = Update_password_single_sign_on_credentials_post_request_body()
...
await client.service_principals.by_service_principal_id('servicePrincipal-id').update_password_single_sign_on_credentials.post(request_body = request_body)
