...
$requestRequestBody->setMarketingNotificationEmails(['marketing@contoso.com',]);
...
$requestRequestBody->setSecurityComplianceNotificationMails(['security@contoso.com',]);
$requestRequestBody->setSecurityComplianceNotificationPhones(['(123) 456-7890',]);
$requestRequestBody->setTechnicalNotificationMails(['tech@contoso.com',]);
