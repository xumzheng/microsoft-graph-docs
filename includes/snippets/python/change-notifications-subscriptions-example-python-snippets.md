...
request_body.changeType = 'created,updated'

request_body.notificationUrl = 'https://webhook.azurewebsites.net/notificationClient'

request_body.resource = '/me/mailfolders(\'inbox\')/messages'

request_body.expirationDateTime = DateTime('2016-03-20T11:00:00.0000000Z')

request_body.clientState = 'SecretClientState'
