...
<!-- { "blockType": "permissions", "name": "intune_devices_manageddevice_deprovision" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-manageddevice-deprovision-permissions.md)]
