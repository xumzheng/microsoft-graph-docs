...
request_config = BookingBusinessRequestBuilderPatchRequestConfiguration(
request_config = BookingBusinessRequestBuilderPatchRequestConfiguration(query_params=)


result = await client.solutions.bookingBusinesses_by_id('bookingBusiness-id').patch(request_body, headers=)
