...
request_config = MarkChatUnreadForUserRequestBuilderPostRequestConfiguration(
request_config = MarkChatUnreadForUserRequestBuilderPostRequestConfiguration(query_params=)
