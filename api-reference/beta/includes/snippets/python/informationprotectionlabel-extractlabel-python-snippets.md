...
request_config = ExtractLabelRequestBuilderPostRequestConfiguration(
request_config = ExtractLabelRequestBuilderPostRequestConfiguration(query_params=)
headers['User-Agent'] = "ContosoLOBApp/1.0"


result = await client.informationProtection.policy.labels.extractLabel.post(request_body, request_config, headers=request_config)
