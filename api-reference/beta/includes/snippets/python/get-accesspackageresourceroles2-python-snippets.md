...
result = await client.identityGovernance_entitlementManagement_accessPackageCatalogsby_id('accessPackageCatalog-id')_accessPackageResourceRoles.get(request_config)
