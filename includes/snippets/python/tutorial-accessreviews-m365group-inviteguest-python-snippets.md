...
request_config = InvitationsRequestBuilderPostRequestConfiguration(
request_config = InvitationsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.invitations.post(request_body, headers=)
