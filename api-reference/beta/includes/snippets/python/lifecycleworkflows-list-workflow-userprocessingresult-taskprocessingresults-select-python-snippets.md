...
result = await client.identityGovernance.lifecycleWorkflows.workflowsby_id('workflow-id').runsby_id('run-id').userProcessingResultsby_id('userProcessingResult-id').taskProcessingResults.get(request_config)
