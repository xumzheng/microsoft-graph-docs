...
request_config = BookmarksRequestBuilderPostRequestConfiguration(
request_config = BookmarksRequestBuilderPostRequestConfiguration(query_params=)


result = await client.search.bookmarks.post(request_body, headers=)
