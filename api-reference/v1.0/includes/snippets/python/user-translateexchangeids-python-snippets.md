...
request_config = TranslateExchangeIdsRequestBuilderPostRequestConfiguration(
request_config = TranslateExchangeIdsRequestBuilderPostRequestConfiguration(query_params=)


result = await client.me.translateExchangeIds.post(request_body, headers=)
