...
result = await client.policies.roleManagementPolicyAssignments_by_id('unifiedRoleManagementPolicyAssignment-id').get(request_configuration = request_configuration)
