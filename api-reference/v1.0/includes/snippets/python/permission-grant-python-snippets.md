...
request_config = GrantRequestBuilderPostRequestConfiguration(
request_config = GrantRequestBuilderPostRequestConfiguration(query_params=)


result = await client.shares_by_id('sharedDriveItem-id').permission.grant.post(request_body, headers=)
