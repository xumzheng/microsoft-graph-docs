...
graphClient.Compliance().Ediscovery().CasesById("case-id").ReviewSetsById("reviewSet-id").MicrosoftGraphEdiscoveryAddToReviewSet().Post(context.Background(), requestBody, nil)
