...
request_config = SchemaRequestBuilderPostRequestConfiguration(
request_config = SchemaRequestBuilderPostRequestConfiguration(query_params=)


await client.external.connections_by_id('externalConnection-id').schema.post(request_body, headers=)
