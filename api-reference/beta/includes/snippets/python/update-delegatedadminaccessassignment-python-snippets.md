...
result = await client.tenantRelationships().delegatedAdminRelationshipsById('delegatedAdminRelationship-id').accessAssignmentsById('delegatedAdminAccessAssignment-id').patch(requestBody, request_config);
