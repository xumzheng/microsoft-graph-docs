...
request_config = AccessPackageResourceRoleScopesRequestBuilderPostRequestConfiguration(
request_config = AccessPackageResourceRoleScopesRequestBuilderPostRequestConfiguration(query_params=)


result = await client.identityGovernance.entitlementManagement.accessPackages_by_id('accessPackage-id').accessPackageResourceRoleScopes.post(request_body, headers=)
